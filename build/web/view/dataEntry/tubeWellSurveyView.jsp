...
<script type="text/javascript" language="javascript">
    ...
    jQuery(function(){
        ...
        $("#searchPoleNo").autocomplete("tubeWellSurveyCont", {
            extraParams: {
                action1: function() { return "getSearchPole_No"}               
            }
        });
        $("#searchIvrsNo").autocomplete("tubeWellSurveyCont", {
            extraParams: {
        ...
        $("#fuse_type1").autocomplete("tubeWellSurveyCont", {
            extraParams: {
                action1: function() { return "getFuseType"}
            }
        });
        $("#starter_type").autocomplete("tubeWellSurveyCont", {
            extraParams: {
                action1: function() { return "getStarterType"}
            }
        });
        $("#mccb_type1").autocomplete("tubeWellSurveyCont", {
            extraParams: {
                action1: function() { return "getMccbType"}
            }
        });
      
        $("#fuse_type2").autocomplete("tubeWellSurveyCont", {
            extraParams: {
                action1: function() { return "getFuseType"}
            }
        });
        $("#starter_make").autocomplete("tubeWellSurveyCont", {
            extraParams: {
                action1: function() { return "getStarterMake"}
            }
        });
        $("#mccb_type2").autocomplete("tubeWellSurveyCont", {
            extraParams: {
                action1: function() { return "getMccbType"}
            }
        });
        
        $("#fuse_type3").autocomplete("tubeWellSurveyCont", {
            extraParams: {
                action1: function() { return "getFuseType"}
            }
        });
       
        $("#mccb_type3").autocomplete("tubeWellSurveyCont", {
            extraParams: {
                action1: function() { return "getMccbType"}
            }
        });
        $("#auto_switch_type").autocomplete("tubeWellSurveyCont", {
            extraParams: {
                action1: function() { return "getAutoSwitchType"}
            }
        });
        $("#main_switch_type").autocomplete("tubeWellSurveyCont", {
            extraParams: {
                action1: function() { return "getMainSwitchType"}
            }
        });
        $("#enclosure_type").autocomplete("tubeWellSurveyCont", {
            extraParams: {
...
//                        }
                        ...
                        function displayMapList1(){
                            var poll_no=document.getElementById("searchPoleNo").value;
                            var ivrs_no=document.getElementById("searchIvrsNo").value;
                            var queryString = "task1=generateMapReport&poll_no="+poll_no+"&ivrs_no="+ivrs_no ;
                            var url = "tubeWellSurveyCont?"+queryString;
                            popupwin = openPopUp(url, "TUbeWell User Details", 500, 1000);
                        ...
                        function openMapForCord() {
                              var url="tubeWellSurveyCont?task1=GetCordinates1";//"getCordinate";
            ...
            <td>
                <DIV id="body" class="maindiv" align="center" >
                    <table width="100%" align="center">
                        ...
                        <tr>
                            <td> <div align="center">
                                    <form name="form0" method="POST" action="tubeWellSurveyCont">
...
<%--                                            <tr>
                                                ...
                                                <td>Ivrs No<input class="input" type="text" id="searchIvrsNo" name="searchIvrsNo" value="${searchIvrsNo}" size="20" ></td>
...
<!--                                                <td>Pole No<input class="input" type="text" id="searchPoleNo" name="searchPoleNo" value="${searchPoleNo}" size="15" ></td>-->
                                            ...
                                            <tr>    <td colspan="5" align="center"><input class="button" type="submit" name="task" id="searchIn" value="Search">
                                                ...
                                                <input type="button" class="" id="viewXLS2" name="viewXLS" value="Excel 2" onclick="displayMapList(id)">
                                                <input type="button" value="View Survey Map" onclick="openCurrentMap()"></td>
                                            </tr>
                                        </table>
                                    </form></div>
                            </td>
                        ...
                        <tr>
                            <td align="center">
                                <form name="form1" method="POST" action="tubeWellSurveyCont">
...
<!--                                                <th style="white-space: normal"  class="heading">Pole No</th>-->
                                                ...
                                                <th style="white-space: normal" class="heading">Meter Status</th>
...
<!--                                                <th style="white-space: normal" class="heading">Meter Status</th>-->
                                                ...
                                                <th style="white-space: normal" class="heading">Starter Functional</th>
                                            ...
                                            <c:forEach var="surveyTypeBean" items="${requestScope['surveyTypeList']}"  varStatus="loopCounter">
                                                <tr  class="${loopCounter.index % 2 == 0 ? 'even': 'odd'}" >
                                                    ...
                                                    <td id="t1c${IDGenerator.uniqueID}"  onclick="fillColumns(id)" >${surveyTypeBean.meter_address}</td>
                        ...
                        <tr>
                            <td align="center">
                                <div>
                                    <form id="form2" name="form2" method="POST" enctype="multipart/form-data"  action="tubeWellSurveyCont" onsubmit="return verify()">
                                        <table id="table2"  class="content" border="0"  align="center" width="953">
                                            ...
                                            <select id="survey_type" name="survey_type" onchange="selectServeyType('');">
                                                <option value="pole_type_survey">TubeWell User Survey</option>
...
<!--                                                    <th class="heading1" style=" width:18%">Survey Meter No</th>-->
                                        ...
                                        <table id="table3" class="content" border="0"  align="center" width="600" style="">
                                            ...
                                            <tr>
                                                <td>  <b class="heading1">Starter Functional</b>
                                            ...
                                            <tr>
                                                ...
                                                <td> <b class="heading1">Longitude</b>
                                                    <input class="input" type="text" id="longitude" name="longitude" value="" size="20" disabled><input class="button" type="button" id="get_cordinate" value="Get Cordinate" onclick="openMapForCord()"></td>
                                                <td> <b class="heading1">Hours</b>
                                                    <input class="input" type="text" id="hours" name="hours" value="" size="20" disabled></td>

                                            </tr>
                                            <tr>
                                               <td> <b class="heading1">Meter Address</b>
                                                    <input class="input" type="text" id="meter_address" name="meter_address" value="" size="20" disabled></td>
                                        ...
                                        <table>  <tr>
                                            ...
                                            <input type="hidden"  name="searchIvrsNo" value="${searchIvrsNo}" >
