...
<script type="text/javascript" language="javascript">
    jQuery(function(){
        $("#zone_name_m").autocomplete("wardCont", {
            extraParams: {
                action1: function() { return "getZoneName"}
            }
        });
        $("#searchWardType").autocomplete("wardCont", {
            extraParams: {
                action1: function() { return "getWardType"}
            }
        });
        $("#searchZoneName").autocomplete("wardCont", {
            extraParams: {
                action1: function() { return "getSearchZoneName"}
            }
        });
    });
    jQuery(function(){
        $("#city_name").autocomplete("wardCont", {
            extraParams: {
                action1: function() { return "getCityType"}
            }
        });
    });
    ...
    function makeEditable(id) {
     ...
     //   document.getElementById("revise").disabled =false;
        ...
        if(id == 'new') {
            document.getElementById("zone_name_m").focus();
    ...
    function fillColumns(id) {
        ...
        document.getElementById("ward_name").value = document.getElementById(t1id +(lowerLimit+4)).innerHTML;
            ...
            <td>
                <DIV id="body" class="maindiv" align="center" >
                    <table width="100%" align="center">
                        ...
                        <tr>
                            <td> <div align="center">
                                    <form name="form0" method="POST" action="wardCont">
                                        <table align="center" class="heading1" width="600">
                                            <tr>
                                                <td>Ward No<input class="input" type="text" id="searchWardType" name="searchWardType" value="${searchWardType}" size="20" ></td>
                                                <td>Zone Name<input class="input" type="text" id="searchZoneName" name="searchZoneName" value="${searchZoneName}" size="20" ></td>
...
<!--                                                <td><input type="button" class="pdf_button" id="viewPdf" name="viewPdf" value="" onclick="displayMapList()"></td>-->
                        ...
                        <tr>
                            <td align="center">
                                <form name="form1" method="POST" action="wardCont">
                                    <DIV class="content_div">
                                        <table id="table1" width="600"  border="1"  align="center" class="content">
                                            ...
                                            <input  type="hidden" id="searchZoneName" name="searchZoneName" value="${searchZoneName}" >
                                        </table></DIV>
                                </form>
                            </td>
                        </tr>
                        ...
                        <tr>
                            <td align="center">
                                <div>
                                    <form name="form2" method="POST" action="wardCont" onsubmit="return verify()">
                                        <table id="table2"  class="content" border="0"  align="center" width="600">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <input class="input" type="text" id="zone_name_m" name="zone_name_m" value="" size="40" disabled>
                                                </td>
                                            </tr>
                                            <tr>
                                            ...
                                            <tr>
                                                ...
                                                <td><input class="input" type="text" id="ward_name" name="ward_name" value="" size="40" disabled></td>
                                            </tr>
