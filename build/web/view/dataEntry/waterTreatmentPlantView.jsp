                                    ...
                                    <form name="form2" method="POST" action="waterTreatmentPlantCont.do" onsubmit="return verify()">
                                        <table id="table2"  class="content" border="0"  align="center" width="600">
                                            ...
                                            <tr>
                                                ...
                                                <th class="heading1">Capacity (Million Ltr. Per Day)</th><td><input class="input" type="text" id="capacityMLD" name="capacityMLD" value="" size="40" disabled></td>
                                            </tr>
                                            <tr>
                                                <th class="heading1">City</th><td><input class="input" type="text" id="cityName" name="cityName" value="" size="40" disabled></td>
                                                <th class="heading1">Address1</th><td><input class="input" type="text" id="address1" name="address1" value="" size="40" disabled></td>
                                            </tr>
                                            <tr>
                                                <th class="heading1">Address2</th><td><input class="input" type="text" id="address2" name="address2" value="" size="40" disabled></td>
