<%-- 
    ...
    Created on : Jul 18, 2018, 2:44:19 PM
    Author     : Shobha
--%>
...
jQuery(function(){
        $("#searchTypeOfUse").autocomplete("TypeOfUseCont.do", {
            extraParams: {
                action1: function() { return "getTypeOfUseName"}
            }
        });
    });
     function makeEditable(id) {
        document.getElementById("type_of_use_name").disabled = false;
    ...
    function setDefaultColor(noOfRowsTraversed, noOfColumns) {
     ...
     function fillColumns(id) {
        ...
        document.getElementById("type_of_use_id").value= document.getElementById(t1id + (lowerLimit + 0)).innerHTML;
        document.getElementById("type_of_use_name").value = document.getElementById(t1id +(lowerLimit+2)).innerHTML;
                ...
                <DIV id="body" class="maindiv" align="center" >
                    <table width="100%" align="center">
                        <tr><td>
                                <table align="center">
                                    <tr>
                                        <td align="center" class="header_table" width="100%">Type Of Use</td>
                        ...
                        <tr>
                            <td> <div align="center">
                                    <form name="form0" method="POST" action="TypeOfUseCont.do">
                                        <table align="center" class="heading1" width="600">
                                            <tr>
                                                <th>Type Of Use</th>
                                                <td><input class="input" type="text" id="searchTypeOfUse" name="searchTypeOfUse" value="${searchTypeOfUse}" size="30" ></td>
...
<!--                                                <td><input type="button" class="pdf_button" id="viewPdf" name="viewPdf" value="" onclick="displayMapList()"></td>-->
                                        ...
                                        <table id="table1" width="600"  border="1"  align="center" class="content">
                                            ...
                                            <c:forEach var="typeOfUseBean" items="${requestScope['TypeOfUseList']}"  varStatus="loopCounter">
                                                <tr  class="${loopCounter.index % 2 == 0 ? 'even': 'odd'}" >
                                                    ...
                                                    <td id="t1c${IDGenerator.uniqueID}" style="display:none" onclick="fillColumns(id)">${typeOfUseBean.typeOfUseiD}</td>
                                                    <td id="t1c${IDGenerator.uniqueID}" onclick="fillColumns(id)" align="center">${lowerLimit - noOfRowsTraversed + loopCounter.count}</td>
                                                    <td id="t1c${IDGenerator.uniqueID}"  onclick="fillColumns(id)" >${typeOfUseBean.typeOfUseName}</td>
                                                    <td id="t1c${IDGenerator.uniqueID}"  onclick="fillColumns(id)" >${typeOfUseBean.remark}</td>
                                                </tr>
                                            </c:forEach>
                                            <tr>
                                            ...
                                            <input  type="hidden" id="searchFuseType" name="searchTypeOfUse" value="${searchTypeOfUse}" >
                                        </table></DIV>
                                </form>
                            </td>
                        </tr>
                        ...
                        <tr>
                            <td align="center">
                                <div>
                                    <form name="form2" method="POST" action="TypeOfUseCont.do" onsubmit="return verify()">
                                        <table id="table2"  class="content" border="0"  align="center" width="600">
                                            ...
                                            <tr>
                                                <th class="heading1">Type Of Use</th>
                                                <td>
                                                    <input class="input" type="hidden" id="type_of_use_id" name="type_of_use_id" value="" >
                                                    <input class="input" type="text" id="type_of_use_name" name="type_of_use_name" value="" size="40" disabled>
                                                </td>
                                            </tr>
<!--                                            <tr style="display:none">
                                            ...
                                            <input type="hidden"  name="searchTypeOfUse" value="${searchTypeOfUse}" >
                                        </table>
                                    </form>
                                </div>
                            </td>
