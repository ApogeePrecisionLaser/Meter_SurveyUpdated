...
jQuery(function(){
        $("#searchAreaName").autocomplete("areaTypeCont", {
            extraParams: {
                action1: function() { return "getsearchAreaName"}
            }
        });
//        $("#searchWardName").autocomplete("areaTypeCont", {
//            extraParams: {
//                action1: function() { return "getsearchWardName"}
//            }
//        });
        $("#searchWardNo").autocomplete("areaTypeCont", {
            extraParams: {
                action1: function() { return "getsearchWardNo"}
           }
        });
...
//            extraParams: {
//                action1: function() { return "getward_name"}
//            }
//        });
                                    ...
                                    <div>
                                        <form name="form0" method="POST" action="areaTypeCont" >
                                            <table class="heading1" align="center" width="600">
                                                <tr>
<!--                                                    <td>Ward Name<input  type="text" name="searchWardName" id="searchWardName" value="${ward_name}" size="20"></td>-->
                                                    <td>Ward No<input  type="text" name="searchWardNo" id="searchWardNo" value="${ward_no}" size="20"></td>
                                                    <td>Area Name<input  type="text" name="searchAreaName" id="searchAreaName" value="${area_name}" size="20"></td>
                                                    <td>
...
<!--                                                    <th class="heading">Ward Name </th>-->
                                                ...
                                                <c:forEach var="area" items="${requestScope['areaTypeList']}" varStatus="loopCounter">
                                                    <tr  class="${loopCounter.index % 2 == 0 ? 'even': 'odd'}" >
                                                        <td id="t1c${IDGenerator.uniqueID}" style="display:none" onclick="fillColumns(id)">${area.area_id}</td>
