...
<html>
    <head>
        ...
        <title>CONSUMPTION FAULTS Page</title>
    </head>
    <body>
            ...
            <td>
                <DIV id="body" class="maindiv" align="center" >
                    <table width="100%" align="center">
                        <tr><td>
                                <table align="center">
                                    <tr>
                                        <td align="center" class="header_table" width="100%">CONSUMPTION FAULTS</td>
                ...
                <td align="center" style="border: none;padding: 1px;background-color: mistyrose" colspan="9" nowrap>
                                    ...
                                    <input type="button" class="button"  id="consumption_faults" name="consumption_faults" value="Sheet" onclick="displayMapList(id);">&nbsp;&nbsp;
