<%-- 
    Document   : contacterView
    Created on : Jul 29, 2014, 12:17:47 PM
    Author     : JPSS
--%>
...
jQuery(function(){
        $("#searchContacterType").autocomplete("contacterTypeCont", {
            extraParams: {
      ...
      function verify() {
        ...
        if(document.getElementById("clickedButton").value == 'Save' || document.getElementById("clickedButton").value == 'Save AS New') {
            ...
            if(myLeftTrim(contacter_type).length == 0) {
                ...
                $("#message").html("<td colspan='5' bgcolor='coral'><b>Contacter Type is required...</b></td>");
                document.getElementById("contacter_type").focus();
    ...
    function setDefaultColor(noOfRowsTraversed, noOfColumns) {
     ...
     function fillColumns(id) {
        ...
        document.getElementById("contacter_id").value= document.getElementById(t1id + (lowerLimit + 0)).innerHTML;
        document.getElementById("contacter_type").value = document.getElementById(t1id +(lowerLimit+2)).innerHTML;
 ...
 function myLeftTrim(str) {
   ...
   var popupwin = null;
            function displayMapList(){
               ...
               var url = "contacterTypeCont?"+queryString;
               popupwin = openPopUp(url, "Contacter Details", 500, 1000);
                ...
                <DIV id="body" class="maindiv" align="center" >
                    <table width="100%" align="center">
                        <tr><td>
                                <table align="center">
                                    <tr>
                                        <td align="center" class="header_table" width="100%">CONTACTER</td>
                        ...
                        <tr>
                            <td> <div align="center">
                                    <form name="form0" method="POST" action="contacterTypeCont">
                                        <table align="center" class="heading1" width="600">
                                            <tr>
                                                <th>Contacter Type</th>
                                                <td><input class="input" type="text" id="searchContacterType" name="searchContacterType" value="${searchContacterType}" size="30" ></td>
                        ...
                        <tr>
                            <td align="center">
                                <form name="form1" method="POST" action="contacterTypeCont">
                                    <DIV class="content_div">
                                        <table id="table1" width="600"  border="1"  align="center" class="content">
                                            ...
                                            <c:forEach var="contacterTypeBean" items="${requestScope['contacterTypeList']}"  varStatus="loopCounter">
                                                <tr  class="${loopCounter.index % 2 == 0 ? 'even': 'odd'}" >
                                                    ...
                                                    <td id="t1c${IDGenerator.uniqueID}" style="display:none" onclick="fillColumns(id)">${contacterTypeBean.contacter_id}</td>
                                                    <td id="t1c${IDGenerator.uniqueID}" onclick="fillColumns(id)" align="center">${lowerLimit - noOfRowsTraversed + loopCounter.count}</td>
                                                    <td id="t1c${IDGenerator.uniqueID}"  onclick="fillColumns(id)" >${contacterTypeBean.contacter_type}</td>
                                                    <td id="t1c${IDGenerator.uniqueID}"  onclick="fillColumns(id)" >${contacterTypeBean.remark}</td>
                                                </tr>
                                            </c:forEach>
                                            <tr>
                                            ...
                                            <input  type="hidden" id="searchContacterType" name="searchContacterType" value="${searchContacterType}" >
                                        </table></DIV>
                                </form>
                            </td>
                        </tr>
                        ...
                        <tr>
                            <td align="center">
                                <div>
                                    <form name="form2" method="POST" action="contacterTypeCont" onsubmit="return verify()">
                                        <table id="table2"  class="content" border="0"  align="center" width="600">
                                            ...
                                            <tr>
                                                <th class="heading1">Contacter Type</th>
                                                <td>
                                                    <input class="input" type="hidden" id="contacter_id" name="contacter_id" value="$(searchContacterType)" >
                                                    <input class="input" type="text" id="contacter_type" name="contacter_type" value="" size="40" disabled>
                                                </td>
                                            </tr>
                                            ...
                                            <input type="hidden"  name="searchContacterType" value="${searchContacterType}" >
                                        </table>
                                    </form>
                                </div>
                            </td>
