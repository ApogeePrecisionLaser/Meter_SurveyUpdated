<%-- 
    Document   : zone_detail_view
    Created on : Sep 23, 2014, 10:40:47 AM
                                ...
                                <td>
                                    <div align="center">
                                        <table  width="80%" border="1" id="table1" align="center" class="content">
                                            <tr>
                                                <th class="heading" style="width: 20px">No.</th>
                                                <th class="heading">Swthg.Pt.No</th>
                                                <th class="heading">Switching Pt. Name</th>
                                          ...
                                          <c:forEach var="switchinglist" items="${requestScope['switchinglist']}" varStatus="loopCounter">
                                                <tr>
                                                    <td id="t1c${IDGenerator.uniqueID}" align="center">${loopCounter.count} </td>
                                                    <td id="t1c${IDGenerator.uniqueID}" >${switchinglist.switching_point_no}</td>
                                                    <td id="t1c${IDGenerator.uniqueID}" >${switchinglist.switching_point_name}</td>
                                                    <td id="t1c${IDGenerator.uniqueID}" >${switchinglist.meter_no}</td>
                                                    <td id="t1c${IDGenerator.uniqueID}" >${switchinglist.switching_no_of_poles}</td>
                                                    <td id="t1c${IDGenerator.uniqueID}" >${switchinglist.feeder}</td>
                                            ...
                                            <tr>
                                              <%--  <th colspan="2" class="heading1" align="center" >Total :</th>
                                                ...
                                                <td><b>${sum_switching_point_nos}</b><input type="hidden" name="st_Total" id="colTotal" value="${sum_switching_point_nos}"></td>
                                                <td><b>${sum_pole_nos}</b><input type="hidden" name="bl_Total" id="bl_Total" value="${sum_pole_nos}"</td>
                                                    --%>
                                            </tr>
                                        </table>
                                    </div>
