...
<html>
            ...
            function initialize() {
                ...
                for (var i=0; i < locations.length; i++) {
                    markers[i] = new google.maps.Marker({
                        ...
                        map: map,
                        icon:"images/survey_image/tubewell_img1.png",
                        url: 'http://www.google.com/',
                        title: "Survey Date: "+$("#survey_date"+i).val()+" \n Survey By: "+$("#survey_by"+i).val()+" \n Pole no.: "+$("#pole_no"+i).val()+" \n Survey Type: "+$("#survey_type"+i).val()
                    });
                    //marker.setMap(map);
                    //markers.push(marker);
    ...
    <body>
        ...
        <c:forEach var="Coordinates" items="${requestScope['CoordinatesList']}" varStatus="loopCounter">
            ...
            <input type="hidden" id="survey_date${loopCounter.count}" value="${Coordinates.survey_date}">
            <input type="hidden" id="survey_by${loopCounter.count}" value="${Coordinates.survey_by}">
            <input type="hidden" id="pole_no${loopCounter.count}" value="${Coordinates.pole_no}">
            <input type="hidden" id="survey_type${loopCounter.count}" value="${Coordinates.survey_type}">
        </c:forEach>
