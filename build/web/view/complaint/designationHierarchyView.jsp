<%-- 
    Document   : designationHierarchyView
    Created on : Jul 2, 2015, 6:12:54 PM
    Author     : jpss
--%>
...
<html>
  ...
  jQuery(function(){
                $("#designation").autocomplete("designationHierarchyCont.do", {
                    extraParams: {
                        action1: function() { return "getDesignationList";}
                    }
                });
                $("#higher_designation").autocomplete("designationHierarchyCont.do", {
                    extraParams: {
                        action1: function() { return "getHigherDesignationList";},
                        action2: function() { return $("#designation").val();}
                    }
                });
                $("#searchDesignation").autocomplete("designationHierarchyCont.do", {
                    extraParams: {
                        action1: function() { return "getDesignationList";}
                    }
                });
                $("#searchHigherDesignation").autocomplete("designationHierarchyCont.do", {
                    extraParams: {
                        action1: function() { return "getsearchHigherDesignationList";}
                    }
                });
                $("#designation").result(function(event, data, formatted){
                    if(document.getElementById("designation").value == 'No Such Designation Exists.'){
                        document.getElementById("designation").value = "";
                    }
                });
                $("#higher_designation").result(function(event, data, formatted){
                    if(document.getElementById("higher_designation").value == 'No Such Higher Designation Exists.'){
                        document.getElementById("higher_designation").value = "";
                    }
                });
            });
            ...
            function verify() {
               ...
               try {
                    ...
                    var result , designation= "", higher_designation="";
                   ...
                   if(document.getElementById("clickedButton").value == 'Save' || document.getElementById("clickedButton").value == 'Save AS New' || document.getElementById("clickedButton").value == 'Update') {
                        designation = $.trim(document.getElementById("designation").value);
                        higher_designation = $.trim(document.getElementById("higher_designation").value);
                       if($.trim(designation).length == 0) {
                            $("#message").html("<td colspan='4' bgcolor='coral'><b>Designation is Required...</b></td>");
                            document.getElementById("designation").focus();
                            return false; // code to stop from submitting the form2.
                        }
                        if($.trim(higher_designation).length == 0) {
                            $("#message").html("<td colspan='4' bgcolor='coral'><b>Higher Designation is Required...</b></td>");
                            document.getElementById("higher_designation").focus();
                            return false; // code to stop from submitting the form2.
                        }
                        if(designation == higher_designation){
                            $("#message").html("<td colspan='4' bgcolor='coral'><b>Designation and Higher Designation must be different...</b></td>");
                            document.getElementById("designation").focus();
                            return false; // code to stop from submitting the form2.
                        }
                  ...
                  if(document.getElementById("designation_hierarchy_id").value == 0){
                        addRow( designation, higher_designation, $("#description").val(), $("#remark").val());
                        $("#message").html("");
                        return false;
                    }
                }catch(e){
            ...
            function addRow(designation, higher_designation, description, remark) {
                var table = document.getElementById('insertTable');
                ...
                element1.name = "designation_hierarchy_id";
                element1.id = "designation_hierarchy_id"+rowCount;
                element1.size = 1;
                element1.value = 1;
                ...
                element2.id = "designation"+rowCount;
                ...
                element3.type = "text";
                element3.name = "higher_designation";
                element3.id = "higher_designation"+rowCount;
                element3.readOnly = true;
                element3.size = 30;
                element3.value = higher_designation;
                ...
                element4.id = "description"+rowCount;
                element4.readOnly = true;
                element4.value = description;
            ...
            function makeEditable(id) {
                ...
                document.getElementById("higher_designation").disabled = false;
               ...
               // document.getElementById("save").disabled = false;
                if(id == 'new') {
                    document.getElementById("designation_hierarchy_id").value = '0';
                    document.getElementById("designation").value = '';
                    document.getElementById("higher_designation").value = '';
           ...
           var columnId = id;                              <%-- holds the id of the column being clicked, excluding the prefix t1c e.g. t1c3 (column 3 of      table 1). --%>
                ...
                document.getElementById("designation_hierarchy_id").value = document.getElementById("designation_hierarchy_id" + rowNo).value;
                document.getElementById("designation").value = document.getElementById(t1id +(lower+1)).innerHTML;
                document.getElementById("higher_designation").value = document.getElementById(t1id +(lower+2)).innerHTML;
                document.getElementById("description").value = document.getElementById(t1id +(lower+3)).innerHTML;
                document.getElementById("remark").value = document.getElementById(t1id +(lower+4)).innerHTML;
                ...
                <td>
                    ...
                    <%--    <form name="form1" method="post" action="complaintTypesCont.do" onsubmit="return verifyform()">   --%>
                            <table width="100%">
                                <tr>
                                    <td>
                                        <table width="100%" border="4">
                                                                  ...
                                                                  <tr>
                                                                      <td align="center" class="header_table" width="90%">Designation Hierarchy</td>
                                ...
                                <td  align="center">
                                    <form name="form0" method="POST" action="designationHierarchyCont.do">
                                        <table  align="center" width="550" class="heading1">
                                            <tr>
                                                <th>Designation</th>
                                                <td><input class="input" type="text" id="searchDesignation" name="searchDesignation" value="${searchDesignation}" size="30" ></td>
                                                <%--<th>Higher Designation</th>
                                                <td><input class="input" type="text" id="searchHigherDesignation" name="searchHigherDesignation" value="${searchHigherDesignation}" size="30" ></td>--%>
                                ...
                                <tr>
                                    <td align="center">
                                        <DIV STYLE="overflow: auto; width: 990px; max-height:350px;padding:0px; margin-bottom:10px">
                                           <form name="form1" method="post" action="designationHierarchyCont.do" onsubmit="return verifyform()">  <%--change --%>
                                            <table id="table1" border="1" align="center"  class="reference">
                                                ...
                                                <c:forEach var="dhList" items="${designationHierarchyList}" varStatus="loopCounter">
                                                    <tr>
                                                        <td id="t1c${IDGenerator.uniqueID}" onclick="fillColumns(id)">${lowerLimit - noOfRowsTraversed + loopCounter.count}
                                                            <input type="hidden" id="designation_hierarchy_id${loopCounter.count}" name="designation_hierarchy_id${loopCounter.count}" value="${dhList.designation_hierarchy_id}">
                                                        </td>
                                                        <%--<td id="t1c${IDGenerator.uniqueID}" onclick="fillColumns(id)">${dhList.officeType}</td>--%>
                                                        <td id="t1c${IDGenerator.uniqueID}" onclick="fillColumns(id)">${dhList.designation}</td>
                                                        <td id="t1c${IDGenerator.uniqueID}" onclick="fillColumns(id)">${dhList.higherDesignation}</td>
                                                        <td id="t1c${IDGenerator.uniqueID}" onclick="fillColumns(id)">${dhList.description}</td>
                                                        <td id="t1c${IDGenerator.uniqueID}" onclick="fillColumns(id)">${dhList.remark}</td>
                                                        ...
                                                        <td colspan="3">
                                                            <table id="insertTable" class="reference" border="1" align="center" width="100%">
                                                                <tr>
                                                                    ...
                                                                    <th class="heading1">Higher Designation</th>
                                ...
                                <tr>
                                    <td align="center">
                                        ...
                                        <DIV style="<%--${!empty(privilegeList) ? '' : 'display:none'}--%>">
                                            <form id="form3" name="form3" method="POST" action="designationHierarchyCont.do" onsubmit="return verify()">
                                                <table border="0"  id="table2" align="center"  class="content" >
                                                    ...
                                                    <tr>
                                                        ...
                                                        <th class="heading1" >Designation</th>
                                                        <td>
                                                            <input type="text" id="designation" name="designation" value="" disabled>
                                                        ...
                                                        <th class="heading1" >Higher Designation</th>
                                                        <td>
                                                            <input type="text" id="higher_designation" name="higher_designation" value="" disabled>
                                                    ...
                                                    <input type="hidden" id="designation_hierarchy_id" name="designation_hierarchy_id" value="0">
                                                    <input  type="hidden" name="searchTypeOfComplaint" value="${searchTypeOfComplaint}"  >
