...
<script type="text/javascript" language="javascript">
    ...
    function worker() {
        $.ajax({url: "junctionDetailCont1.do?searchJunction="+ $("#searchJunction").val(), data: "action1=getJunctionData&q=", dataType: 'json', success: function(response_data) {
                    ...
                    var jsonarray=response_data.arrayObj;

                    var $table = $( "<table></table>" );
                   //   $table.removeData( $("#myDiv") );
                     $('#myDiv').empty();
                 for(var i=0;i<jsonarray.length;i++){
                 var a=i+1;
                 var  WaterTreatmentPlantName=jsonarray[i]["WaterTreatmentPlantName"];
                 var  OverHeadTankName=jsonarray[i]["OverHeadTankName"];
                 var  OhLevelId=jsonarray[i]["OhLevelId"];
                 var   Level_a=jsonarray[i]["Level_a"];
                 var   Level_b=jsonarray[i]["Level_b"];
                 var   Value_of_ab=jsonarray[i]["Value_of_ab"];
                 var   DateTime=jsonarray[i]["DateTime"];
                 var   remark=jsonarray[i]["remark"];
                 var  Level_datetime=jsonarray[i]["Level_datetime"];
                 var   Step=jsonarray[i]["Step"];
                 var   Level1=jsonarray[i]["Level1"];
                 var   Level2=jsonarray[i]["Level2"];
                 var   Level3=jsonarray[i]["Level3"];
                 var   Level4=jsonarray[i]["Level4"];
                 var   Value_of_34=jsonarray[i]["Value_of_34"];
                 var   Level_of_34=jsonarray[i]["Level_of_34"];

                   var $line = $( "<tr></tr>" );   
                $line.append( $( "<td></td>" ).html(a) );
                $line.append( $( "<td></td>" ).html(WaterTreatmentPlantName) );
                $line.append( $( "<td></td>" ).html(OverHeadTankName) );
                $line.append( $( "<td></td>" ).html(OhLevelId) );
                $line.append( $( "<td></td>" ).html(Level_a) );
                $line.append( $( "<td></td>" ).html(Level_b) );
                $line.append( $( "<td></td>" ).html(Value_of_ab) );
                $line.append( $( "<td></td>" ).html(DateTime) );
                $line.append( $( "<td></td>" ).html(remark) );
//                $line.append( $( "<td></td>" ).html(Level_datetime) );
                $line.append( $( "<td></td>" ).html(Step) );
                $line.append( $( "<td></td>" ).html(Level1) );
                $line.append( $( "<td></td>" ).html(Level2) );
                $line.append( $( "<td></td>" ).html(Level3) );
                $line.append( $( "<td></td>" ).html(Level4) );
                $line.append( $( "<td></td>" ).html(Value_of_34) );
                $line.append( $( "<td></td>" ).html(Level_of_34) );
                $table.append( $line );              
             }           
                        ...
                        <table width="100%">
                            ...
                            <tr>
                                <td align="center"> <div id="search_div">
                                        <form name="form0" method="get" action="junctionDetailCont1.do" onsubmit="return verify()">
...
<!--                                                    <td  colspan="" align="center">
                        ...
                        <tr>
                            <td align="center">
                                <DIV class="content_div" id="myDiv">
