...
<html>
  ...
  jQuery(function(){
                $("#searchTypeOfComplaint").autocomplete("complaintTypesCont.do", {
                    extraParams: {
            ...
            function verify() {
               ...
               try {
                    ...
                    var result , complaint_type= "", complaint_type_eng="";
                   ...
                   if(document.getElementById("clickedButton").value == 'Save' || document.getElementById("clickedButton").value == 'Save AS New' || document.getElementById("clickedButton").value == 'Update') {
                       ...
                       if($.trim(complaint_type).length == 0) {
                        ...
                        /*if($.trim(complaint_type_eng).length == 0) {
                            $("#message").html("<td colspan='8' bgcolor='coral'><b>Complaint  Type English is Required...</b></td>");
            ...
            function addRow(complaint_type , description) {
                ...
                element3.type = "text";
                element3.name = "complaint_type_eng";
                element3.id = "complaint_type_eng"+rowCount;
                element3.size = 30;
                element3.value = complaint_type_eng;
           ...
           var columnId = id;                              <%-- holds the id of the column being clicked, excluding the prefix t1c e.g. t1c3 (column 3 of      table 1). --%>
                ...
                document.getElementById("complaint_type_id").value = document.getElementById("com_complaint_type_id" + rowNo).value;
                document.getElementById("complaint_type").value = document.getElementById(t1id +(lower+1)).innerHTML;
                ...
                <td>
                    ...
                    <%--    <form name="form1" method="post" action="complaintTypesCont.do" onsubmit="return verifyform()">   --%>
                            <table width="100%">
                                ...
                                <td  align="center">
                                    <form name="form0" method="POST" action="complaintTypesCont.do">
                                ...
                                <tr>
                                    <td align="center">
                                        <DIV STYLE="overflow: auto; width: 990px; max-height:350px;padding:0px; margin-bottom:10px">
                                           <form name="form1" method="post" action="complaintTypesCont.do" onsubmit="return verifyform()">  <%--change --%>
                                            <table id="table1" border="1" align="center"  class="reference">
                                                <tr>
                                                    <th class="heading">S.No.</th>
                                                    <th class="heading">Complaint Type</th>
                                                    <!--<th class="heading">Complaint Type English</th>-->
                                                ...
                                                <c:forEach var="asso" items="${ComplaintTypeList}" varStatus="loopCounter">
                                                    <tr>
                                                        ...
                                                        <%--<td id="t1c${IDGenerator.uniqueID}" onclick="fillColumns(id)">${asso.complaint_type_eng}</td>--%>
                                                        ...
                                                        <td colspan="3">
                                                            <table id="insertTable" class="reference" border="1" align="center" width="100%">
                                                                <tr>
                                                                    ...
                                                                    <!--<th class="heading1" >Complaint Type English</th>-->
                                ...
                                <tr>
                                    <td align="center">
                                        ...
                                        <DIV style="<%--${!empty(privilegeList) ? '' : 'display:none'}--%>">
                                            <form id="form3" name="form3" method="POST" action="complaintTypesCont.do" onsubmit="return verify()">
                                                <table border="0"  id="table2" align="center"  class="content" >
                                                    ...
                                                    <tr>
                                                        <th class="heading1" >Complaint Type</th>
                                                        <td>
                                                            <input type="text" id="complaint_type" name="complaint_type" value="" disabled>
                                                        </td>
                                                        <!--<th class="heading1" >Complaint Type English</th>-->
                                                        <td>
                                                            <input style="display: none" type="text" id="complaint_type_eng" name="complaint_type_eng" value="">
                                                        </td>
                                                        <th class="heading1" >Remark</th>
                                                        <td>
