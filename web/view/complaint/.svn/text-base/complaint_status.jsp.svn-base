        ...
        <script type="text/javascript" language="javascript">
            ...
            function singleCheckUncheck(id){
                ...
                if ($('#check_complaint'+id).is(':checked')) {
                    $("#complaint_status_id"+id).val("1");
                }else{
                    $("#complaint_status_id"+id).val("0");
                }
                ...
                try {
                    ...
                    if(document.getElementById("clickedButton").value == 'Save' || document.getElementById("clickedButton").value == 'Save AS New' || document.getElementById("clickedButton").value == 'Update') {
                        ...
                        if($.trim(status).length == 0) {
                            $("#message").html("<td colspan='8' bgcolor='coral'><b>Complaint Status is Required...</b></td>");
                    ...
                    if(document.getElementById("complaint_status_id").value == 0){
                        addRow( status, $("#description").val());
                        $("#message").html("");
                        return false;
                    }
                }catch(e){
            ...
            function addRow(status , description) {
                ...
                element1.name = "complaint_status_id";
                element1.id = "complaint_status_id"+rowCount;
                element1.size = 1;
                element1.value = 1;
            ...
            function makeEditable(id) {
              ...
              if(id == 'new') {
                    document.getElementById("complaint_status_id").value = '0';
            ...
            function fillColumns(id) {
                ...
                document.getElementById("complaint_status_id").value = document.getElementById("com_status_id" + rowNo).value;
                document.getElementById("status").value = document.getElementById(t1id +(lower+1)).innerHTML;
            ...
            <tr>
                <td>
                    <div id="main_div" class="maindiv" style="min-height: 600px ;max-height: auto">
                        <form name="form1" method="post" action="complaintStatusCont.do" onsubmit="return verifyform()">
                            <table width="100%">
                                <tr>
                                    <td>
                                        <table width="100%" border="4">
                                            <tr>
                                                <td align="center" class="header_table" width="90%">Complaint Status</td>
                                                ...
                                                <c:forEach var="asso" items="${ComplaintStatusList}" varStatus="loopCounter">
                                                    <tr>
                                                        <td id="t1c${IDGenerator.uniqueID}" onclick="fillColumns(id)">${lowerLimit - noOfRowsTraversed + loopCounter.count}
                                                            <input type="hidden" id="com_status_id${loopCounter.count}" name="com_status_id${loopCounter.count}" value="${asso.complaint_status_id}">
                                                            
                                                        </td>
                                                        <td id="t1c${IDGenerator.uniqueID}" onclick="fillColumns(id)">${asso.complaint_status}</td>
                                ...
                                <tr>
                                    <td align="center">
                                        <DIV style="<%--${!empty(privilegeList) ? '' : 'display:none'}--%>">
                                            <form id="form3" name="form3" method="POST" action="complaintStatusCont.do" onsubmit="return verify()">
                                                <table border="0"  id="table2" align="center"  class="content" >
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                          <input type="text" id="status" name="status" value="" disabled>
                                                        </td>
                                                        <th class="heading1" >Description</th>
                                                        <td>
                                                    ...
                                                    <tr>
                                                        <td align='center' colspan="4">
                                                          <%--  <input class="button" type="submit" name="update" id="update" value="Update" onclick="setStatus(id);"  style="display:${myfn:isContainPrivileges(privilegeList, 'update') ? '' : 'none'}" disabled> --%>
                                                    ...
                                                    <input type="hidden" id="complaint_status_id" name="complaint_status_id" value="0">
