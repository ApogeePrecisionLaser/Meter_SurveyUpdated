...
<html>
    ...
    <script type="text/javascript">
         jQuery(function(){
           $("#overheadtank_name").autocomplete("OverheadtankMeterMapCont.do", {
            extraParams: {
          ...
          jQuery(function(){
           $("#meter_name").autocomplete("OverheadtankMeterMapCont.do", {
            extraParams: {
                action1: function() { return "getMeterName" }
            }
              });
          });

          jQuery(function(){
           $("#searchoverheadtank_name").autocomplete("OverheadtankMeterMapCont.do", {
            extraParams: {
          ...
          jQuery(function(){
           $("#searchmeter_name").autocomplete("OverheadtankMeterMapCont.do", {
            extraParams: {
                action1: function() { return "getSearchMeterName" }
            }
              });
          });
     function fillColumns(id)
     {
      ...
      document.getElementById("overheadtankmetermap_id").value=document.getElementById(t1id + (lowerLimit + 0)).innerHTML;
      document.getElementById("overheadtank_name").value=document.getElementById(t1id + (lowerLimit + 2)).innerHTML;
      document.getElementById("meter_name").value=document.getElementById(t1id + (lowerLimit + 3)).innerHTML;
...
//        }
    ...
    <body>
       <table align="center" class="main" cellpadding="0" cellspacing="0" border="1" width="1000px">
            ...
            <table align="center">
                                    <tr>
                                        <td align="center" class="header_table" width="90%"><b>OverheadTank Meter map</b></td>
                                    </tr>
                                </table>
            ...
            <tr>
                 <td>
                     <div class="maindiv" id="body">
                       <form name="form" action="OverheadtankMeterMapCont.do">

                           <table width="100%" align="center" >
                                   <tr align="center">
                                        <td>

                                                   <span class="heading1">OverheadTank Name</span>
                                                   <input class="input" type="text" id="searchoverheadtank_name" name="searchoverheadtank_name" value="${searchOverheadtank_name}" size="30">
                                                   <span class="heading1">Meter Name</span>
                                                   <input class="input" type="text" id="searchmeter_name" name="searchmeter_name" value="${searchMeter_Name}" size="30">
                            ...
                            <tr>
                                <td align="center">
                                    <div  class="content_div" style="width:990px" >
                                        ...
                                        <form name="form1" action="OverheadtankMeterMapCont.do">
                                           <TABLE BORDER="1" align="center" cellpadding="5" class="content" >
                                                <TR>
                                                 <th class="heading" >S.no</th>
                                                 <th class="heading" >Overheadtank name</th>
                                                ...
                                                <c:forEach var="item_name" items="${requestScope['list']}" varStatus="loopCounter">
                                                  <TR class="${loopCounter.index % 2 == 0 ? 'even': 'odd'}" class="bcolor">
                                                    <td id="t1c${IDGenerator.uniqueID}" style="display:none" onclick="fillColumns(id)">${item_name.overheadtank_metermap_id}</td>
                                                    <td id="t1c${IDGenerator.uniqueID}" onclick="fillColumns(id)" align="center">${lowerLimit + loopCounter.count- noOfRowsTraversed}</td>
                                                    <TD id="t1c${IDGenerator.uniqueID}" onclick="fillColumns(id)">${item_name.overheadtank_name}</TD>
                                                    <TD id="t1c${IDGenerator.uniqueID}" onclick="fillColumns(id)">${item_name.meter_name}</TD>
                                        ...
                                        <div  style="width:990px" >
                                            <form name="form2" action="OverheadtankMeterMapCont.do" onsubmit="return verify()">
                                                                                ...
                                                                                <tr>
                                                                                   <td>Overheadtank Name</td>
                                                                                   <td><input class="input" type="hidden" id="overheadtankmetermap_id" name="overheadtankmetermap_id" value="" >
                                                                                   <input type="text" id="overheadtank_name" name="overheadtank_name" value="" disabled></td>
                                                                               </tr>
                                                                               <tr>
                                                                                   <td>Meter Name</td>
                                                                                     <td><input type="text" id="meter_name" name="meter_name" value="" disabled></td>
                                                                               </tr>
