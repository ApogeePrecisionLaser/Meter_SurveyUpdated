<%-- 
    Document   : Pole_Light_Type
    Created on : 2 Mar, 2021, 11:38:02 AM
...
<script type="text/javascript" language="javascript">
    jQuery(function(){
        $("#searchSourceType").autocomplete("PoleLightTypeCont", {
            extraParams: {
                action1: function() { return "getSourceType"}
            }
        });
         $("#searchWattageType").autocomplete("PoleLightTypeCont", {
            extraParams: {
     ...
     jQuery(function(){
        $("#source_type").autocomplete("PoleLightTypeCont", {
            extraParams: {
                action1: function() { return "getSourceType"}
            }
        });

        $("#wattage_value").autocomplete("PoleLightTypeCont", {
            extraParams: {
                action1: function() { return "getWattageType"}
             }
        });
    ...
    function setDefaultColor(noOfRowsTraversed, noOfColumns) {
     ...
     function makeEditable(id) {
        document.getElementById("light_type").disabled = false;
    ...
    var popupwin = null;
            function displayMapList(){
               ...
               var url = "PoleLightTypeCont?"+queryString;
            ...
            <td>
                <DIV id="body" class="maindiv" align="center" >
                    <table width="100%" align="center">
                        ...
                        <tr>
                            <td> <div align="center">
                                    <form name="form0" method="POST" action="PoleLightTypeCont">
                        ...
                        <tr>
                            <td align="center">
                                <form name="form1" method="POST" action="PoleLightTypeCont">
                        ...
                        <tr>
                            <td align="center">
                                <div>
                                    <form name="form2" method="POST" action="PoleLightTypeCont" onsubmit="return verify()">
                                        <table id="table2"  class="content" border="0"  align="center" width="600">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <input class="input" type="text" id="light_type" name="light_type" value="" size="40" disabled>
                                                </td>
                                            </tr>
                                               <tr >
                                                <th class="heading1">Is Parent</th>
                                                <td id="pid" style="display:none">
                                                    <input type="radio" id="yes" name="isparent" value="Yes" onclick="mywork(id)">
                    <label for="male">Yes</label> 
                    <input type="radio" id="no" name="isparent" value="No" onclick="mywork(id)">  
                                                <label for="male">No</label><br></td>
                                            </tr>
                                            
                                            <tr  >
                                                <th class="heading1">Is child</th>
                                                <td id="childrow" style="display: none">
                                                <input type="radio" id="yes" name="ischild" value="Yes">
                    <label for="male">Yes</label> 
                    <input type="radio" id="no" name="ischild" value="No">  
                                                <label for="male">No</label><br></td>
                                            </tr>
                                            
                                               <tr>
                                                <th class="heading1">Child</th>
                                                <td>
                                                    <input class="input" type="hidden" id="light_type_id" name="light_type_id" value="$(searchSourceType)" >
                                                    <input class="input" type="text" id="Child" name="Child" value="" size="40" disabled>
                                                </td>
                                            </tr>
