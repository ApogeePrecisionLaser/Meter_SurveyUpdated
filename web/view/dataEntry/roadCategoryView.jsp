<%-- 
    Document   : roadCategoryView
    Created on : Jul 9, 2014, 7:35:57 PM
    Author     : JPSS
--%>
...
jQuery(function(){
        $("#searchCategoryType").autocomplete("roadCatTypeCont", {
            extraParams: {
      ...
      function verify() {
        ...
        if(document.getElementById("clickedButton").value == 'Save' || document.getElementById("clickedButton").value == 'Save AS New') {
            ...
            if(myLeftTrim(category_name).length == 0) {
                ...
                $("#message").html("<td colspan='5' bgcolor='coral'><b>Road Category Name is required...</b></td>");
                document.getElementById("category_name").focus();
    ...
    function setDefaultColor(noOfRowsTraversed, noOfColumns) {
     ...
     function fillColumns(id) {
        ...
        document.getElementById("category_id").value= document.getElementById(t1id + (lowerLimit + 0)).innerHTML;
        document.getElementById("category_name").value = document.getElementById(t1id +(lowerLimit+2)).innerHTML;
      ...
      //  document.getElementById("created_date").value = document.getElementById(t1id +(lowerLimit+3)).innerHTML;
        document.getElementById("width").value = document.getElementById(t1id +(lowerLimit+3)).innerHTML;
 ...
 function myLeftTrim(str) {
      ...
      var popupwin = null;
            function displayMapList(){
               ...
               var url = "roadCatTypeCont?"+queryString;
               popupwin = openPopUp(url, "Road Category Type Map Details", 500, 1000);
                ...
                <DIV id="body" class="maindiv" align="center" >
                    <table width="100%" align="center">
                        <tr><td>
                                <table align="center">
                                    <tr>
                                        <td align="center" class="header_table" width="100%">ROAD CATEGORY</td>
                        ...
                        <tr>
                            <td> <div align="center">
                                    <form name="form0" method="POST" action="roadCatTypeCont">
                                        <table align="center" class="heading1" width="600">
                                            <tr>
                                                <th>Road Category</th>
                                                <td><input class="input" type="text" id="searchCategoryType" name="searchCategoryType" value="${searchCategoryType}" size="30" ></td>
                        ...
                        <tr>
                            <td align="center">
                                <form name="form1" method="POST" action="roadCatTypeCont">
                                        ...
                                        <table id="table1" width="600"  border="1"  align="center" class="content">
                                            ...
                                            <c:forEach var="roadTypeBean" items="${requestScope['roadTypeList']}"  varStatus="loopCounter">
                                                <tr  class="${loopCounter.index % 2 == 0 ? 'even': 'odd'}" >
                                                    ...
                                                    <td id="t1c${IDGenerator.uniqueID}" style="display:none" onclick="fillColumns(id)">${roadTypeBean.category_id}</td>
                                                    <td id="t1c${IDGenerator.uniqueID}" onclick="fillColumns(id)" align="center">${lowerLimit - noOfRowsTraversed + loopCounter.count}</td>
                                                    <td id="t1c${IDGenerator.uniqueID}"  onclick="fillColumns(id)" >${roadTypeBean.category_name}</td>
                                                  
                                                   
                                                    <td id="t1c${IDGenerator.uniqueID}"  onclick="fillColumns(id)" >${roadTypeBean.width}</td>
                                            ...
                                            <input  type="hidden" id="searchCategoryType" name="searchCategoryType" value="${searchCategoryType}" >
                                        </table></DIV>
                                </form>
                            </td>
                        </tr>
                        ...
                        <tr>
                            <td align="center">
                                <div>
                                    <form name="form2" method="POST" action="roadCatTypeCont" onsubmit="return verify()">
                                        <table id="table2"  class="content" border="0"  align="center" width="600">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <input class="input" type="hidden" id="category_id" name="category_id" value="$(searchCategoryType)" >
                                                    <input class="input" type="text" id="category_name" name="category_name" value="" size="40" disabled>
                                                </td>
                                            </tr>
                                            ...
                                            <tr>
                                                <th class="heading1">Width</th><td><input class="input" type="text" id="width" name="width" value="" size="40" disabled></td>
                                            </tr>
                                            <tr>
                                            ...
                                            <input type="hidden"  name="searchCategoryType" value="${searchCategoryType}" >
                                        </table>
                                    </form>
                                </div>
                            </td>
