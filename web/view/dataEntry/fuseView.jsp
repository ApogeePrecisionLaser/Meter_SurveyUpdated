<%-- 
    Document   : fuseView
    Created on : Jul 29, 2014, 12:17:22 PM
    Author     : JPSS
--%>
...
jQuery(function(){
        $("#searchFuseType").autocomplete("fuseTypeCont", {
            extraParams: {
     ...
     function makeEditable(id) {
        document.getElementById("fuse_type").disabled = false;
    ...
    function setDefaultColor(noOfRowsTraversed, noOfColumns) {
     ...
     function fillColumns(id) {
        ...
        document.getElementById("fuse_id").value= document.getElementById(t1id + (lowerLimit + 0)).innerHTML;
        document.getElementById("fuse_type").value = document.getElementById(t1id +(lowerLimit+2)).innerHTML;
                ...
                <DIV id="body" class="maindiv" align="center" >
                    <table width="100%" align="center">
                        <tr><td>
                                <table align="center">
                                    <tr>
                                        <td align="center" class="header_table" width="100%">FUSE</td>
                        ...
                        <tr>
                            <td> <div align="center">
                                    <form name="form0" method="POST" action="fuseTypeCont">
                                        <table align="center" class="heading1" width="600">
                                            <tr>
                                                <th>Fuse Type</th>
                                                <td><input class="input" type="text" id="searchFuseType" name="searchFuseType" value="${searchFuseType}" size="30" ></td>
                                        ...
                                        <table id="table1" width="600"  border="1"  align="center" class="content">
                                            ...
                                            <c:forEach var="fuseTypeBean" items="${requestScope['fuseTypeList']}"  varStatus="loopCounter">
                                                <tr  class="${loopCounter.index % 2 == 0 ? 'even': 'odd'}" >
                                                    ...
                                                    <td id="t1c${IDGenerator.uniqueID}" style="display:none" onclick="fillColumns(id)">${fuseTypeBean.fuse_id}</td>
                                                    <td id="t1c${IDGenerator.uniqueID}" onclick="fillColumns(id)" align="center">${lowerLimit - noOfRowsTraversed + loopCounter.count}</td>
                                                    <td id="t1c${IDGenerator.uniqueID}"  onclick="fillColumns(id)" >${fuseTypeBean.fuse_type}</td>
                                                    <td id="t1c${IDGenerator.uniqueID}"  onclick="fillColumns(id)" >${fuseTypeBean.remark}</td>
                                                </tr>
                                            </c:forEach>
                                            <tr>
                                            ...
                                            <input  type="hidden" id="searchFuseType" name="searchFuseType" value="${searchFuseType}" >
                                        </table></DIV>
                                </form>
                            </td>
                        </tr>
                        ...
                        <tr>
                            <td align="center">
                                <div>
                                    <form name="form2" method="POST" action="fuseTypeCont" onsubmit="return verify()">
                                        <table id="table2"  class="content" border="0"  align="center" width="600">
                                            ...
                                            <tr>
                                                <th class="heading1">Fuse Type</th>
                                                <td>
                                                    <input class="input" type="hidden" id="fuse_id" name="fuse_id" value="$(searchFuseType)" >
                                                    <input class="input" type="text" id="fuse_type" name="fuse_type" value="" size="40" disabled>
                                                </td>
                                            </tr>
                                            ...
                                            <input type="hidden"  name="searchFuseType" value="${searchFuseType}" >
                                        </table>
                                    </form>
                                </div>
                            </td>
