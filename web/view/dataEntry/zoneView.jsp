...
<script type="text/javascript" language="javascript">
    jQuery(function(){
              $("#searchZoneType").autocomplete("zoneCont", {
            extraParams: {
                action1: function() { return "getZoneType"}
            }
        });
//         $("#division_name_m").autocomplete("zoneCont", {
//            extraParams: {
//                action1: function() { return "getDivisionName"}
//            }
//        });
    });
    ...
    function makeEditable(id) {
        ...
        document.getElementById("zone_m").disabled = false;
        //document.getElementById("division_name_m").disabled = false;
        ...
        /* if(document.getElementById("active").value == "N" )
            {
                document.getElementById("zone_m").disabled = true;
       ...
       // document.getElementById("revise").disabled =false;
        ...
        if(id == 'new') {
            ...
            document.getElementById("zone_id_m").value ='';
       ...
       //    document.getElementById("revise").disabled = true;
            ...
            document.getElementById("zone_m").focus();
    ...
    function verify() {
        ...
        if(document.getElementById("clickedButton").value == 'Save' || document.getElementById("clickedButton").value == 'Save AS New' || document.getElementById("clickedButton").value == 'Revise'||document.getElementById("clickedButton").value == 'Delete') {
            var zone_m = document.getElementById("zone_m").value;
            var a=document.getElementById("active").value;
            //    alert(a);
            if(myLeftTrim(zone_m).length == 0) {
            ...
            var division_name = document.getElementById("division_name_m").value;

            if(myLeftTrim(division_name).length == 0) {

                // document.getElementById("message").innerHTML = "<td colspan='5' bgcolor='coral'><b>Organisation Type Name is required...</b></td>";
                $("#message").html("<td colspan='5' bgcolor='coral'><b>Division Name is required...</b></td>");
    ...
    function fillColumns(id) {
        ...
        document.getElementById("zone_id_m").value= document.getElementById(t1id + (lowerLimit + 0)).innerHTML;
        //document.getElementById("division_name_m").value = document.getElementById(t1id +(lowerLimit+2)).innerHTML;
        //document.getElementById("division_name_m").value = document.getElementById(t1id +(lowerLimit+2)).innerHTML;
        document.getElementById("zone_m").value = document.getElementById(t1id +(lowerLimit+2)).innerHTML;
                ...
                <DIV id="body" class="maindiv" align="center" >
                    <table width="100%" align="center">
                        <tr><td>
                                <table align="center">
                                    <tr>
                                        <td align="center" class="header_table" width="100%">ZONE DETAIL</td>
                        ...
                        <tr>
                            <td> <div align="center">
                                    <form name="form0" method="POST" action="zoneCont">
                                        <table align="center" class="heading1" width="600">
                                            <tr>
                                                <td>Zone Name<input class="input" type="text" id="searchZoneType" name="searchZoneType" value="${searchZoneType}" size="20" ></td>
...
<!--                                                <th class="heading">Division Name</th>-->
                                            ...
                                            <c:forEach var="zoneTypeBean" items="${requestScope['zoneTypeList']}"  varStatus="loopCounter">
                                                <tr  class="${loopCounter.index % 2 == 0 ? 'even': 'odd'}" >
                                                    ...
                                                    <td id="t1c${IDGenerator.uniqueID}" style="display:none" onclick="fillColumns(id)">${zoneTypeBean.zone_id_m}</td>
                                                    <td id="t1c${IDGenerator.uniqueID}" onclick="fillColumns(id)" align="center">${lowerLimit - noOfRowsTraversed + loopCounter.count}</td>
                                                    
                                                    <td id="t1c${IDGenerator.uniqueID}"  onclick="fillColumns(id)" >${zoneTypeBean.zone_m}</td>
                                                    <td id="t1c${IDGenerator.uniqueID}"  onclick="fillColumns(id)" >${zoneTypeBean.description}</td>
                                                </tr>
                                            </c:forEach>
                                            <tr>
                                            ...
                                            <input  type="hidden" id="searchZoneType" name="searchZoneType" value="${searchZoneType}" >
                                        </table></DIV>
                                </form>
                            </td>
                        </tr>
                        ...
                        <tr>
                            <td align="center">
                                <div>
                                    <form name="form2" method="POST" action="zoneCont" onsubmit="return verify()">
...
<!--                                            <tr >
                                                ...
                                                <td>
                                                    <input class="input" type="hidden" id="zone_id_m" name="zone_id_m" value="" >
                                                    <input class="input" type="text" id="division_name_m" name="division_name_m" value="" size="40" disabled>
                                                </td>
                                            </tr>-->
                                            <tr>
                                                <th class="heading1">Zone Name</th>
                                                <td><input class="input" type="hidden" id="zone_id_m" name="zone_id_m" value="" >
                                                    <input class="input" type="text" id="zone_m" name="zone_m" value="" size="40" disabled></td>
                                            </tr>
                                            <tr>
                                                <th class="heading1">Description</th>
                                                <td><input class="input" type="text" id="description" name="description" value="" size="40" disabled></td>
                                            </tr>
                                            ...
                                            <input type="hidden"  name="searchZoneType" value="${searchZoneType}" >
                                        </table>
                                    </form>
                                </div>
                            </td>
