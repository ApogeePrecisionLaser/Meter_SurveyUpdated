<%-- 
    Document   : trafficView
    Created on : Jul 8, 2014, 10:41:00 PM
    Author     : JPSS
--%>
...
<script type="text/javascript" language="javascript">
 jQuery(function(){
        $("#searchTrafficType").autocomplete("trafficTypeCont", {
            extraParams: {
    ...
    function verify() {
        ...
        if(document.getElementById("clickedButton").value == 'Save' || document.getElementById("clickedButton").value == 'Save AS New') {
            ...
            if(myLeftTrim(traffic_type).length == 0) {
                ...
                $("#message").html("<td colspan='5' bgcolor='coral'><b>Traffic Name is required...</b></td>");
                document.getElementById("traffic_type").focus();
    ...
    function fillColumns(id) {
        ...
        document.getElementById("traffic_type_id").value= document.getElementById(t1id + (lowerLimit + 0)).innerHTML;
        document.getElementById("traffic_type").value = document.getElementById(t1id +(lowerLimit+2)).innerHTML;
  //      document.getElementById("created_by").value = document.getElementById(t1id +(lowerLimit+3)).innerHTML;
    ...
    var popupwin = null;
            function displayMapList(){
               ...
               var url = "trafficTypeCont?"+queryString;
               popupwin = openPopUp(url, "Traffic Type Map Details", 500, 1000);
                ...
                <DIV id="body" class="maindiv" align="center" >
                    <table width="100%" align="center">
                        <tr><td>
                                <table align="center">
                                    <tr>
                                        <td align="center" class="header_table" width="100%">TRAFFIC TYPE</td>
                        ...
                        <tr>
                            <td> <div align="center">
                                    <form name="form0" method="POST" action="trafficTypeCont">
                                        <table align="center" class="heading1" width="600">
                                            <tr>
                                                <th>Traffic Type</th>
                                                <td><input class="input" type="text" id="searchWattageType" name="searchTrafficType" value="${searchTrafficType}" size="30" ></td>
                        ...
                        <tr>
                            <td align="center">
                                <form name="form1" method="POST" action="trafficTypeCont">
                                    <DIV class="content_div">
                                        <table id="table1" width="600"  border="1"  align="center" class="content">
                                            ...
                                            <c:forEach var="trafficTypeBean" items="${requestScope['trafficTypeList']}"  varStatus="loopCounter">
                                                <tr  class="${loopCounter.index % 2 == 0 ? 'even': 'odd'}" >
                                                    ...
                                                    <td id="t1c${IDGenerator.uniqueID}" style="display:none" onclick="fillColumns(id)">${trafficTypeBean.traffic_type_id}</td>
                                                    <td id="t1c${IDGenerator.uniqueID}" onclick="fillColumns(id)" align="center">${lowerLimit - noOfRowsTraversed + loopCounter.count}</td>
                                                    <td id="t1c${IDGenerator.uniqueID}"  onclick="fillColumns(id)" >${trafficTypeBean.traffic_type}</td>
                                                   
                                               
                                                    <td id="t1c${IDGenerator.uniqueID}"  onclick="fillColumns(id)">${trafficTypeBean.remark}</td>
                                                </tr>
                                            </c:forEach>
                                            <tr>
                                            ...
                                            <input  type="hidden" id="searchWattageType" name="searchTrafficType" value="${searchTrafficType}" >
                                        </table></DIV>
                                </form>
                            </td>
                        </tr>
                        ...
                        <tr>
                            <td align="center">
                                <div>
                                    <form name="form2" method="POST" action="trafficTypeCont" onsubmit="return verify()">
                                        <table id="table2"  class="content" border="0"  align="center" width="600">
                                            ...
                                            <tr>
                                                <th class="heading1">Traffic_Type</th>
                                                <td>
                                                    <input class="input" type="hidden" id="traffic_type_id" name="traffic_type_id" value="$(searchTrafficType)" >
                                                    <input class="input" type="text" id="traffic_type" name="traffic_type" value="" size="40" disabled>
                                                </td>
                                            </tr>
                                            ...
                                            <input type="hidden"  name="searchTrafficType" value="${searchTrafficType}" >
                                        </table>
                                    </form>
                                </div>
                            </td>
