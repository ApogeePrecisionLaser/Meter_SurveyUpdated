<%-- 
    Document   : roadUseView
    Created on : Jul 9, 2014, 5:17:17 PM
    Author     : JPSS
--%>
...
jQuery(function(){
        $("#searchRoadType").autocomplete("roadUseTypeCont", {
            extraParams: {
    ...
    function setDefaultColor(noOfRowsTraversed, noOfColumns) {
     ...
     function fillColumns(id) {
        ...
        document.getElementById("road_use_id").value= document.getElementById(t1id + (lowerLimit + 0)).innerHTML;
        document.getElementById("road_use").value = document.getElementById(t1id +(lowerLimit+2)).innerHTML;
 ...
 function myLeftTrim(str) {
   ...
   var popupwin = null;
            function displayMapList(){
               ...
               var url = "roadUseTypeCont?"+queryString;
               popupwin = openPopUp(url, "Road Use Map Details", 500, 1000);
                ...
                <DIV id="body" class="maindiv" align="center" >
                    <table width="100%" align="center">
                        <tr><td>
                                <table align="center">
                                    <tr>
                                        <td align="center" class="header_table" width="100%">ROAD USE</td>
                        ...
                        <tr>
                            <td> <div align="center">
                                    <form name="form0" method="POST" action="roadUseTypeCont">
                                        <table align="center" class="heading1" width="600">
                                            <tr>
                                                <th>Road Type</th>
                                                <td><input class="input" type="text" id="searchRoadType" name="searchRoadType" value="${searchRoadType}" size="30" ></td>
                        ...
                        <tr>
                            <td align="center">
                                <form name="form1" method="POST" action="roadUseTypeCont">
                                        ...
                                        <table id="table1" width="600"  border="1"  align="center" class="content">
                                            ...
                                            <c:forEach var="roadTypeBean" items="${requestScope['roadTypeList']}"  varStatus="loopCounter">
                                                <tr  class="${loopCounter.index % 2 == 0 ? 'even': 'odd'}" >
                                                    ...
                                                    <td id="t1c${IDGenerator.uniqueID}" style="display:none" onclick="fillColumns(id)">${roadTypeBean.road_use_id}</td>
                                                    <td id="t1c${IDGenerator.uniqueID}" onclick="fillColumns(id)" align="center">${lowerLimit - noOfRowsTraversed + loopCounter.count}</td>
                                            ...
                                            <input  type="hidden" id="searchRoadType" name="searchRoadType" value="${searchRoadType}" >
                                        </table></DIV>
                                </form>
                            </td>
                        </tr>
                        ...
                        <tr>
                            <td align="center">
                                <div>
                                    <form name="form2" method="POST" action="roadUseTypeCont" onsubmit="return verify()">
                                        <table id="table2"  class="content" border="0"  align="center" width="600">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <input class="input" type="hidden" id="road_use_id" name="road_use_id" value="$(searchRoadType)" >
                                                    <input class="input" type="text" id="road_use" name="road_use" value="" size="40" disabled>
                                                </td>
                                            </tr>
                                            ...
                                            <input type="hidden"  name="searchRoadType" value="${searchRoadType}" >
                                        </table>
                                    </form>
                                </div>
                            </td>
