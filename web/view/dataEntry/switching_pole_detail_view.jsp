<%-- 
    Document   : switching_pole_detail_view
    Created on : Sep 23, 2014, 2:59:39 PM
...
<html>
    <head>
        ...
        <title>${zone}&nbsp; -->&nbsp; ${switching_pt_name}&nbsp;Pole Detail</title>
                            ...
                            <tr>
                                <td>
                                    <div id="wrapper" align="center" style="margin-bottom: 0px;padding-bottom: 0px">
                                        <div class="block1" style="width: 700px">
                                            <div><h1>${zone}&nbsp; -->&nbsp; ${switching_pt_name}&nbsp;Pole Detail</h1></div>
                                        </div>
                                    </div>
                                </td>
                            </tr>
                                    ...
                                    <div align="center">
                                        <table  width="80%" border="1" id="table1" align="center" class="content">
                                            <tr>
                                                ...
                                                <th class="heading">Pole Span</th>
                                                <th class="heading">Pole Height</th>
                                                <th class="heading">Mounting Height</th>
                                            </tr>
                                          <c:forEach var="polelist" items="${requestScope['polelist']}" varStatus="loopCounter">
                                                <tr>
                                                    ...
                                                    <td id="t1c${IDGenerator.uniqueID}" >${polelist.pole_no}</td>
                                                    <td id="t1c${IDGenerator.uniqueID}" >${polelist.pole_type}</td>
                                                    <td id="t1c${IDGenerator.uniqueID}" >${polelist.pole_span}</td>
                                                    <td id="t1c${IDGenerator.uniqueID}" >${polelist.pole_height}</td>
                                                    <td id="t1c${IDGenerator.uniqueID}" >${polelist.mounting_height}</td>
                                                </tr>
                                            </c:forEach>
                                            <tr>
