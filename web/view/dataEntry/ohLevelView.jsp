...
<script type="text/javascript" language="javascript">
    ...
    function fillColumns(id) {
        ...
        $("#level").val(document.getElementById(t1id + (lowerLimit + 4)).innerHTML);
        var date_time = document.getElementById(t1id + (lowerLimit + 5)).innerHTML;
        var date = date_time.split(" ");
        $("#level_datetime").val(date[0]);
        var time = date[1].split(":");
        $("#level_time_hour").val(time[0]);
        $("#level_time_min").val(time[1]);
        $("#remark").val(document.getElementById(t1id + (lowerLimit + 6)).innerHTML);
                                            ...
                                            <table id="table1" width="800"  border="1"  align="center" class="content">
                                                ...
                                                <c:forEach var="ohLevelBean" items="${requestScope['ohLevelList']}"  varStatus="loopCounter">
                                                    <tr class="${loopCounter.index % 2 == 0 ? 'even': 'odd'}">
                                                        ...
                                                        <td id="t1c${IDGenerator.uniqueID}"  onclick="fillColumns(id)" style="text-align: right; padding-right: 8px;" >${ohLevelBean.level}</td>
