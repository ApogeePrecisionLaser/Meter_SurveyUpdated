  ...
  var CheckUncheck;
         $(document).ready(function(){             
           ...
           jQuery(function(){
                ...
                $("#parentHeaderName").autocomplete("CircuitInfoCont", {
            extraParams: {
                action1: function() { return "getParentHeaderName" }
            }
              });

               $("#childHeaderName").autocomplete("CircuitInfoCont", {
            extraParams: {
               ...
               $("#searchheader_index").autocomplete("CircuitInfoCont", {
            extraParams: {
                action1: function() { return "getSearchIndex" }
            }
              });

               $("#searchSub_header_name").autocomplete("CircuitInfoCont", {
            extraParams: {
                action1: function() { return "getSearchSubHeader" }
            }
              });

               $("#searchParent_header_name").autocomplete("CircuitInfoCont", {
            extraParams: {
...
//                var item_already =$("option:selected", $("#item_already")).val();
                ...
                var url = "CircuitInfoCont?" + queryString;
                popupwin = openPopUp(url, "Header List", 595, 750);
            }
             function changeFormFields_parent(id){
         document.getElementById("addparentmain1").style.display='block';
         document.getElementById("parentheader").style.display='block';
...
<!--                                                </td>-->
                            ...
                            <tr>
                                <td align="center">
                                    <form name="form1" method="POST" action="CircuitInfoCont">
                                        <DIV class="content_div">
                                            <table border="1" id="table1" align="center"  class="content" width="380">
                                                <tr>
                                                    ...
                                                    <th class="heading" >Sub Circuit Index</th>
                                                    <th class="heading" >Sub Circuit Name</th>
                                                    <th class="heading" >Parent Circuit Name</th>                                                  
                            ...
                            <tr>
                                <td align="center">                                    
                                    <form name="form2" method="POST" action="CircuitInfoCont" onsubmit="return verify()">
   ...
   <tr id="addparentmain">
       <th class="headingparent" id="headingparent" >Parent</th><td><input class="" type="checkbox"   id="parent" name="parent" value="" onclick="changeFormFields_parent(id)" ></td>
                                            </tr>
   <tr id="addparentmain1" style="display: none">
                                                <th class="heading1">Parent Header</th><td><input class="" type="text" id="parentheader" style="display: none" name="parentheader" value="" ></td>
                                                <td><input class="" type="submit" id="addnow" style="display: none" name="task" value="AddMainParent"  ></td>    </tr>
