...
<script type="text/javascript" language="javascript">
    jQuery(function(){
        ...
        $("#searchStatusType").autocomplete("divisionCont", {
            extraParams: {
                action1: function() { return "getStatusType"}
            }
        });
        $("#status_type").autocomplete("divisionCont", {
            extraParams: {
                action1: function() { return "getStatusTYPE"}
            }
        });
    ...
    function fillColumns(id) {
        ...
        document.getElementById("status_id").value= document.getElementById(t1id + (lowerLimit + 0)).innerHTML;
                ...
                <DIV id="body" class="maindiv" align="center" >
                    <table width="100%" align="center">
                        <tr><td>
                                <table align="center">
                                    <tr>
                                        <td align="center" class="header_table" width="100%">STATUS TYPE</td>
                            ...
                            <td> <div align="center">
                                    <form name="form0" method="POST" action="divisionCont">
                                        <table align="center" class="heading1" width="600">
                                            <tr>
                                                <td>Division Name<input class="input" type="text" id="searchStatusType" name="searchStatusType" value="${searchStatusType}" size="20" ></td>
                                        ...
                                        <table id="table1" width="600"  border="1"  align="center" class="content">
                                            ...
                                            <c:forEach var="divisionTypeBean" items="${requestScope['divisionTypeList']}"  varStatus="loopCounter">
                                                <tr  class="${loopCounter.index % 2 == 0 ? 'even': 'odd'}" >
                                                    ...
                                                    <td id="t1c${IDGenerator.uniqueID}" style="display:none" onclick="fillColumns(id)">${divisionTypeBean.status_id}</td>
                                                    <td id="t1c${IDGenerator.uniqueID}" onclick="fillColumns(id)" align="center">${lowerLimit - noOfRowsTraversed + loopCounter.count}</td>
                                                    <td id="t1c${IDGenerator.uniqueID}"  onclick="fillColumns(id)" >${divisionTypeBean.status_type}</td>
                                    ...
                                    <form name="form2" method="POST" action="divisionCont" onsubmit="return verify()">
                                        <table id="table2"  class="content" border="0"  align="center" width="600">
                                            ...
                                            <tr >
                                                ...
                                                <td>
                                                    <input class="input" type="hidden" id="status_id" name="status_id" value="" >
                                                    <input class="input" type="status_type" id="status_type" name="status_type" value="" size="40" disabled>
                                                </td>
                                            </tr>
