    ...
    <body>
        <div>
            <table>
                <tr>
                    <td>
                        <form name="form1" method="post" action="PoleSurveyCont" enctype= "multipart/form-data">
                            <DIV align="center" style="display: list-item" >
                                 <table id="table1" align="center" width="100%">
                                    ...
                                    <c:forEach var="imageList" items="${requestScope['imageList']}" varStatus="loopCounter">      
                                         ...
                                         <img  src="PoleSurveyCont?task1=getImageThumb&image_name=${imageList.first_pole_image}&imageid1=${imageid1}"  width="380px" height="250px" alt=""/>
