...
jQuery(function(){
        $("#searchSourceType").autocomplete("lightSourceTypeCont", {
            extraParams: {
    ...
    function setDefaultColor(noOfRowsTraversed, noOfColumns) {
     ...
     function fillColumns(id) {
        ...
        document.getElementById("source_type_id").value= document.getElementById(t1id + (lowerLimit + 0)).innerHTML;
 ...
 function myLeftTrim(str) {
       ...
       var popupwin = null;
            function displayMapList(){
               ...
               var url = "lightSourceTypeCont?"+queryString;
                ...
                <DIV id="body" class="maindiv" align="center" >
                    <table width="100%" align="center">
                        <tr><td>
                                <table align="center">
                                    <tr>
                                        <td align="center" class="header_table" width="100%">LIGHT SOURCE TYPE</td>
                        ...
                        <tr>
                            <td> <div align="center">
                                    <form name="form0" method="POST" action="lightSourceTypeCont">
                                        <table align="center" class="heading1" width="600">
                                            <tr>
                                                <th>Light Source Type</th>
                                                <td><input class="input" type="text" id="searchSourceType" name="searchSourceType" value="${searchSourceType}" size="30" ></td>
                        ...
                        <tr>
                            <td align="center">
                                <form name="form1" method="POST" action="lightSourceTypeCont">
                                    <DIV class="content_div">
                                        <table id="table1" width="600"  border="1"  align="center" class="content">
                                            ...
                                            <c:forEach var="sourceTypeBean" items="${requestScope['sourceTypeList']}"  varStatus="loopCounter">
                                                <tr  class="${loopCounter.index % 2 == 0 ? 'even': 'odd'}" >
                                                    ...
                                                    <td id="t1c${IDGenerator.uniqueID}" style="display:none" onclick="fillColumns(id)">${sourceTypeBean.source_type_id}</td>
                                                    <td id="t1c${IDGenerator.uniqueID}" onclick="fillColumns(id)" align="center">${lowerLimit - noOfRowsTraversed + loopCounter.count}</td>
                                                    <td id="t1c${IDGenerator.uniqueID}"  onclick="fillColumns(id)" >${sourceTypeBean.source_type}</td>
                                                  
                                                 
                                                    <td id="t1c${IDGenerator.uniqueID}"  onclick="fillColumns(id)" >${sourceTypeBean.active}</td>
                        ...
                        <tr>
                            <td align="center">
                                <div>
                                    <form name="form2" method="POST" action="lightSourceTypeCont" onsubmit="return verify()">
                                        <table id="table2"  class="content" border="0"  align="center" width="600">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <input class="input" type="hidden" id="source_type_id" name="source_type_id" value="$(searchSourceType)" >
