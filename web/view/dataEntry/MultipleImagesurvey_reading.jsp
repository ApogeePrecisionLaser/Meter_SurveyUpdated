    ...
    <body>
        <div>
            <table>
                <tr>
                    <td>
                        <form name="form1" method="post" action="PrimarySurveyController" enctype= "multipart/form-data">
                            <DIV align="center" style="display: list-item" >
                                 <table id="table1" align="center" width="100%">
                                    ...
                                    <c:forEach var="imageList" items="${requestScope['imageList']}" varStatus="loopCounter">      
                                         ...
                                         <img  src="PrimarySurveyController?task1=getImageThumb&image_name=${imageList.image_name_meter_reading}&imageid1=${imageid1}"  width="380px" height="250px" alt=""/>
