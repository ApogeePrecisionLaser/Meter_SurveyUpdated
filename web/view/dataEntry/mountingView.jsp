<%-- 
    Document   : mountingView
    Created on : Jul 9, 2014, 1:59:40 PM
    Author     : JPSS
--%>
...
jQuery(function(){
        $("#searchMountingType").autocomplete("mountingTypeCont", {
            extraParams: {
    ...
    function verify() {
        ...
        if(document.getElementById("clickedButton").value == 'Save' || document.getElementById("clickedButton").value == 'Save AS New') {
            ...
            if(myLeftTrim(mounting_type).length == 0) {
                ...
                $("#message").html("<td colspan='5' bgcolor='coral'><b>Mounting Name is required...</b></td>");
                document.getElementById("mounting_type").focus();
    ...
    function setDefaultColor(noOfRowsTraversed, noOfColumns) {
     ...
     function fillColumns(id) {
        ...
        document.getElementById("mounting_type_id").value= document.getElementById(t1id + (lowerLimit + 0)).innerHTML;
        document.getElementById("mounting_type").value = document.getElementById(t1id +(lowerLimit+2)).innerHTML;
 ...
 function myLeftTrim(str) {
  ...
  var popupwin = null;
            function displayMapList(){
               ...
               var queryString = "task=generateMapReport&searchMountingType="+searchMountingType  ;
               var url = "mountingTypeCont?"+queryString;
                ...
                <DIV id="body" class="maindiv" align="center" >
                    <table width="100%" align="center">
                        <tr><td>
                                <table align="center">
                                    <tr>
                                        <td align="center" class="header_table" width="100%">MOUNTING TYPE</td>
                        ...
                        <tr>
                            <td> <div align="center">
                                    <form name="form0" method="POST" action="mountingTypeCont">
                                        <table align="center" class="heading1" width="600">
                                            <tr>
                                                <th>Mounting Type</th>
                                                <td><input class="input" type="text" id="searchMountingType" name="searchMountingType" value="${searchMountingType}" size="30" ></td>
                        ...
                        <tr>
                            <td align="center">
                                <form name="form1" method="POST" action="mountingTypeCont">
                                    <DIV class="content_div">
                                        <table id="table1" width="600"  border="1"  align="center" class="content">
                                            <tr>
                                                <th class="heading">S.No.</th>
                                                <th class="heading">Mounting Type</th>
                                            <!--   <th class="heading">Created By</th>-->
                                             <!--   <th class="heading">Created Date</th>-->
                                                <th class="heading">Active</th>
                                                <th class="heading">Remark</th>
                                            </tr>
                                            <!---below is the code to show all values on jsp page fetched from mountingTypeList of mountingController     --->
                                            <c:forEach var="mountingTypeBean" items="${requestScope['mountingTypeList']}"  varStatus="loopCounter">
                                                <tr  class="${loopCounter.index % 2 == 0 ? 'even': 'odd'}" >
                                                    ...
                                                    <td id="t1c${IDGenerator.uniqueID}" style="display:none" onclick="fillColumns(id)">${mountingTypeBean.mounting_type_id}</td>
                                                    <td id="t1c${IDGenerator.uniqueID}" onclick="fillColumns(id)" align="center">${lowerLimit - noOfRowsTraversed + loopCounter.count}</td>
                                                    <td id="t1c${IDGenerator.uniqueID}"  onclick="fillColumns(id)" >${mountingTypeBean.mounting_type}</td>
                                                

                                                    <td id="t1c${IDGenerator.uniqueID}"  onclick="fillColumns(id)" >${mountingTypeBean.active}</td>
                                                    <td id="t1c${IDGenerator.uniqueID}"  onclick="fillColumns(id)" >${mountingTypeBean.remark}</td>
                                                </tr>
                                            </c:forEach>
                                            <tr>
                        ...
                        <tr>
                            <td align="center">
                                <div>
                                    <form name="form2" method="POST" action="mountingTypeCont" onsubmit="return verify()">
                                        <table id="table2"  class="content" border="0"  align="center" width="600">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <input class="input" type="hidden" id="mounting_type_id" name="mounting_type_id" value="$(searchMountingType)" >
                                                    <input class="input" type="text" id="mounting_type" name="mounting_type" value="" size="40" disabled>
                                                </td>
                                            </tr>
