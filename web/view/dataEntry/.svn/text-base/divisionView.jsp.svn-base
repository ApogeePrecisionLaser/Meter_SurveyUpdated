...
<script type="text/javascript" language="javascript">
    jQuery(function(){
        ...
        $("#searchDivisionType").autocomplete("divisionCont", {
            extraParams: {
                action1: function() { return "getDivisionName"}
            }
        });
        $("#circle_name").autocomplete("divisionCont", {
            extraParams: {
                action1: function() { return "getCircleName"}
            }
        });
    });
    ...
    function makeEditable(id) {
        ...
        document.getElementById("circle_name").disabled = false;
        document.getElementById("description").disabled = false;
        document.getElementById("save").disabled = false;

        /* if(document.getElementById("active").value == "N" )
            {
                document.getElementById("division_name_m").disabled = true;
    ...
    function fillColumns(id) {
        ...
        document.getElementById("division_id_m").value= document.getElementById(t1id + (lowerLimit + 0)).innerHTML;
        document.getElementById("circle_name").value = document.getElementById(t1id +(lowerLimit+2)).innerHTML;
        document.getElementById("division_name_m").value = document.getElementById(t1id +(lowerLimit+3)).innerHTML;
                ...
                <DIV id="body" class="maindiv" align="center" >
                    <table width="100%" align="center">
                        <tr><td>
                                <table align="center">
                                    <tr>
                                        <td align="center" class="header_table" width="100%">DIVISION DETAIL</td>
                        ...
                        <tr>
                            <td> <div align="center">
                                    <form name="form0" method="POST" action="divisionCont">
                                        <table align="center" class="heading1" width="600">
                                            <tr>
                                                <td>Division Name<input class="input" type="text" id="searchDivisionType" name="searchDivisionType" value="${searchDivisionType}" size="20" ></td>
                        ...
                        <tr>
                            <td align="center">
                                <form name="form1" method="POST" action="divisionCont">
                                        ...
                                        <table id="table1" width="600"  border="1"  align="center" class="content">
                                            ...
                                            <c:forEach var="divisionTypeBean" items="${requestScope['divisionTypeList']}"  varStatus="loopCounter">
                                                <tr  class="${loopCounter.index % 2 == 0 ? 'even': 'odd'}" >
                                                    ...
                                                    <td id="t1c${IDGenerator.uniqueID}" style="display:none" onclick="fillColumns(id)">${divisionTypeBean.division_id_m}</td>
                                                    <td id="t1c${IDGenerator.uniqueID}" onclick="fillColumns(id)" align="center">${lowerLimit - noOfRowsTraversed + loopCounter.count}</td>
                                                    <td id="t1c${IDGenerator.uniqueID}"  onclick="fillColumns(id)" >${divisionTypeBean.circle_name}</td>
                                                    <td id="t1c${IDGenerator.uniqueID}"  onclick="fillColumns(id)" >${divisionTypeBean.division_name_m}</td>
                        ...
                        <tr>
                            <td align="center">
                                <div>
                                    <form name="form2" method="POST" action="divisionCont" onsubmit="return verify()">
                                        <table id="table2"  class="content" border="0"  align="center" width="600">
                                            ...
                                            <tr >
                                                <th class="heading1">Circle Name</th>
                                                <td>
                                                    <input class="input" type="hidden" id="division_id_m" name="division_id_m" value="" >
                                                    <input class="input" type="circle_name" id="circle_name" name="circle_name" value="" size="40" disabled>
                                                </td>
                                            </tr>
                                            <tr>
                                                <th class="heading1">Division Name</th>
                                                <td><input class="input" type="text" id="division_name_m" name="division_name_m" value="" size="40" disabled></td>
                                            </tr>

                                            <tr>
                                                <th class="heading1">description</th><td><input class="input" type="text" id="description" name="description" value="" size="40" disabled></td>
                                            </tr>
