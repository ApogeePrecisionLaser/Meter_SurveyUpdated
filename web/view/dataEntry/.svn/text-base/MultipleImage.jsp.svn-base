    ...
    <body>
        <div>
            <table>
                <tr>
                    <td>
                        <form name="form1" method="post" action="newSwitchingPointSurveyCont.do" enctype= "multipart/form-data">
                                ...
                                <table id="table1" align="center" width="100%">
                                    <tr><td align="center">
                                     <c:forEach var="imgList" items="${imageList}" varStatus="loopCounter">
                                        <a  href="newSwitchingPointSurveyCont.do?task1=getImage&img_destination=${imgList}" rel="lightbox[group1]">
                                            <img  src="newSwitchingPointSurveyCont.do?task1=getImageThumb&img_destination=${imgList}"  width="180px" height="100px"/></a>
                                    </c:forEach>
                                    </td></tr>
