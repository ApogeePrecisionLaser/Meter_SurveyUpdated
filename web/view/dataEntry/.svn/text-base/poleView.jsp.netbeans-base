<%-- 
    Document   : poleView
    Created on : Jul 9, 2014, 3:40:33 PM
    Author     : JPSS
--%>
...
jQuery(function(){
        $("#searchPoleType").autocomplete("poleTypeCont", {
            extraParams: {
      ...
      function verify() {
        ...
        if(document.getElementById("clickedButton").value == 'Save' || document.getElementById("clickedButton").value == 'Save AS New') {
            ...
            if(myLeftTrim(pole_type).length == 0) {
                ...
                $("#message").html("<td colspan='5' bgcolor='coral'><b>Pole Name is required...</b></td>");
                document.getElementById("pole_type").focus();
 ...
 function myLeftTrim(str) {
     ...
     var popupwin = null;
            function displayMapList(){
               ...
               alert(searchPoleType);
               var queryString = "task=generateMapReport&searchPoleType="+searchPoleType ;
               var url = "poleTypeCont?"+queryString;
               popupwin = openPopUp(url, "Pole Type Map Details", 500, 1000);          
            }
                ...
                <DIV id="body" class="maindiv" align="center" >
                    <table width="100%" align="center">
                        <tr><td>
                                <table align="center">
                                    <tr>
                                        <td align="center" class="header_table" width="100%">POLE TYPE</td>
                        ...
                        <tr>
                            <td> <div align="center">
                                    <form name="form0" method="POST" action="poleTypeCont">
                                        <table align="center" class="heading1" width="600">
                                            <tr>
                                                <th>Pole Type</th>
                                                <td><input class="input" type="text" id="searchPoleType" name="searchPoleType" value="${searchPoleType}" size="30" ></td>
                                ...
                                <form name="form1" method="POST" action="poleTypeCont">
                                    <DIV class="content_div">
                                        <table id="table1" width="600"  border="1"  align="center" class="content">
                                            ...
                                            <!---below is the code to show all values on jsp page fetched from poleTypeList of poleController     --->
                                            <c:forEach var="poleTypeBean" items="${requestScope['poleTypeList']}"  varStatus="loopCounter">
                                                <tr  class="${loopCounter.index % 2 == 0 ? 'even': 'odd'}" >
                                                    ...
                                                    <td id="t1c${IDGenerator.uniqueID}" style="display:none" onclick="fillColumns(id)">${poleTypeBean.pole_type_id}</td>
                                                    <td id="t1c${IDGenerator.uniqueID}" onclick="fillColumns(id)" align="center">${lowerLimit - noOfRowsTraversed + loopCounter.count}</td>
                        ...
                        <tr>
                            <td align="center">
                                <div>
                                    <form name="form2" method="POST" action="poleTypeCont" onsubmit="return verify()">
                                        <table id="table2"  class="content" border="0"  align="center" width="600">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <input class="input" type="hidden" id="pole_type_id" name="pole_type_id" value="$(searchPoleType)" >
                                                    <input class="input" type="text" id="pole_type" name="pole_type" value="" size="40" disabled>
                                                </td>
                                            </tr>
