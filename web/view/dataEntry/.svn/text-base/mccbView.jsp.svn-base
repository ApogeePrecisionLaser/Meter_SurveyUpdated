...
jQuery(function(){
        $("#searchMccbType").autocomplete("mccbTypeCont", {
            extraParams: {
 ...
 function myLeftTrim(str) {
   ...
   var popupwin = null;
            function displayMapList(){
               ...
               var url = "mccbTypeCont?"+queryString;
                ...
                <DIV id="body" class="maindiv" align="center" >
                    <table width="100%" align="center">
                        <tr><td>
                                <table align="center">
                                    <tr>
                                        <td align="center" class="header_table" width="100%">MCCB</td>
                        ...
                        <tr>
                            <td> <div align="center">
                                    <form name="form0" method="POST" action="mccbTypeCont">
                                        <table align="center" class="heading1" width="600">
                                            <tr>
                                                <th>Mccb Type</th>
                                                <td><input class="input" type="text" id="searchMccbType" name="searchMccbType" value="${searchMccbType}" size="30" ></td>
                                        ...
                                        <table id="table1" width="600"  border="1"  align="center" class="content">
                                            ...
                                            <c:forEach var="mccbTypeBean" items="${requestScope['mccbTypeList']}"  varStatus="loopCounter">
                                                <tr  class="${loopCounter.index % 2 == 0 ? 'even': 'odd'}" >
                                                    ...
                                                    <td id="t1c${IDGenerator.uniqueID}" style="display:none" onclick="fillColumns(id)">${mccbTypeBean.mccb_id}</td>
                                                    <td id="t1c${IDGenerator.uniqueID}" onclick="fillColumns(id)" align="center">${lowerLimit - noOfRowsTraversed + loopCounter.count}</td>
                                                    <td id="t1c${IDGenerator.uniqueID}"  onclick="fillColumns(id)" >${mccbTypeBean.mccb_type}</td>
                                                    <td id="t1c${IDGenerator.uniqueID}"  onclick="fillColumns(id)" >${mccbTypeBean.remark}</td>
                                                </tr>
                                            </c:forEach>
                                            <tr>
                                            ...
                                            <input  type="hidden" id="searchMccbType" name="searchMccbType" value="${searchMccbType}" >
                                        </table></DIV>
                                </form>
                            </td>
                        </tr>
                        <tr>
                            <td align="center">
                                <div>
                                    <form name="form2" method="POST" action="mccbTypeCont" onsubmit="return verify()">
                                        <table id="table2"  class="content" border="0"  align="center" width="600">
                                            ...
                                            <tr>
                                                <th class="heading1">Mccb Type</th>
                                                <td>
                                                    <input class="input" type="hidden" id="mccb_id" name="mccb_id" value="$(searchMccbType)" >
                                                    <input class="input" type="text" id="mccb_type" name="mccb_type" value="" size="40" disabled>
                                                </td>
                                            </tr>
                                            ...
                                            <input type="hidden"  name="searchMccbType" value="${searchMccbType}" >
                                        </table>
                                    </form>
                                </div>
                            </td>
