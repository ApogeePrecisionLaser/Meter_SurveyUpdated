<%-- 
    Document   : wattageView
    Created on : Jul 9, 2014, 3:21:27 AM
    Author     : JPSS
--%>
...
jQuery(function(){
        $("#searchWattageType").autocomplete("wattageTypeCont", {
            extraParams: {
     ...
     function makeEditable(id) {
        document.getElementById("wattage_type").disabled = false;
        ...
        if(id == 'new') {
            ...
            document.getElementById("wattage_type").focus();
     ...
     function setStatus(id) {
      ...
      function verify() {
        ...
        if(document.getElementById("clickedButton").value == 'Save' || document.getElementById("clickedButton").value == 'Save AS New') {
            var wattage_type = document.getElementById("wattage_type").value;

            if(myLeftTrim(wattage_type).length == 0) {

                // document.getElementById("message").innerHTML = "<td colspan='5' bgcolor='coral'><b>Organisation Type Name is required...</b></td>";
                $("#message").html("<td colspan='5' bgcolor='coral'><b>Wattage Name is required...</b></td>");
                document.getElementById("wattage_type").focus();
    ...
    function setDefaultColor(noOfRowsTraversed, noOfColumns) {
     ...
     function fillColumns(id) {
        ...
        document.getElementById("wattage_type_id").value= document.getElementById(t1id + (lowerLimit + 0)).innerHTML;
        document.getElementById("wattage_type").value = document.getElementById(t1id +(lowerLimit+2)).innerHTML;
 ...
 function myLeftTrim(str) {
   ...
   var popupwin = null;
            function displayMapList(){
               ...
               var url = "wattageTypeCont?"+queryString;
               popupwin = openPopUp(url, "Wattage Details", 500, 1000);
                ...
                <DIV id="body" class="maindiv" align="center" >
                    <table width="100%" align="center">
                        <tr><td>
                                <table align="center">
                                    <tr>
                                        <td align="center" class="header_table" width="100%">WATTAGE</td>
                        ...
                        <tr>
                            <td> <div align="center">
                                    <form name="form0" method="POST" action="wattageTypeCont">
                                        <table align="center" class="heading1" width="600">
                                            <tr>
                                                <th>Wattage Type</th>
                                                <td><input class="input" type="text" id="searchWattageType" name="searchWattageType" value="${searchWattageType}" size="30" ></td>
                        ...
                        <tr>
                            <td align="center">
                                <form name="form1" method="POST" action="wattageTypeCont">
                                    <DIV class="content_div">
                                        <table id="table1" width="600"  border="1"  align="center" class="content">
                                            <tr>
                                                <th class="heading">S.No.</th>
                                                <th class="heading">Wattage Value</th>
                   <!--                       <th class="heading">Created By</th>-->
                                            ...
                                            <c:forEach var="wattageTypeBean" items="${requestScope['wattageTypeList']}"  varStatus="loopCounter">
                                                <tr  class="${loopCounter.index % 2 == 0 ? 'even': 'odd'}" >
                                                    ...
                                                    <td id="t1c${IDGenerator.uniqueID}" style="display:none" onclick="fillColumns(id)">${wattageTypeBean.wattage_id}</td>
                                                    <td id="t1c${IDGenerator.uniqueID}" onclick="fillColumns(id)" align="center">${lowerLimit - noOfRowsTraversed + loopCounter.count}</td>
                                                    <td id="t1c${IDGenerator.uniqueID}"  onclick="fillColumns(id)" >${wattageTypeBean.wattage_value}</td>
                                                    
                                                    
                                                    <td id="t1c${IDGenerator.uniqueID}"  onclick="fillColumns(id)" >${wattageTypeBean.active}</td>
                                                    <td id="t1c${IDGenerator.uniqueID}"  onclick="fillColumns(id)" >${wattageTypeBean.remark}</td>
                                                </tr>
                                            </c:forEach>
                                            <tr>
                        ...
                        <tr>
                            <td align="center">
                                <div>
                                    <form name="form2" method="POST" action="wattageTypeCont" onsubmit="return verify()">
                                        <table id="table2"  class="content" border="0"  align="center" width="600">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <input class="input" type="hidden" id="wattage_type_id" name="wattage_type_id" value="$(searchWattageType)" >
                                                    <input class="input" type="text" id="wattage_type" name="wattage_type" value="" size="40" disabled>
                                                </td>
                                            </tr>
