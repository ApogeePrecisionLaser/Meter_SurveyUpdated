<%-- 
    Document   : timerView
    Created on : Jul 29, 2014, 12:18:12 PM
    Author     : JPSS
--%>
...
jQuery(function(){
        $("#searchTimerType").autocomplete("timerTypeCont", {
            extraParams: {
                action1: function() { return "getTimerType"}
            }
        });
    });
     function makeEditable(id) {
        document.getElementById("timer_type").disabled = false;
      ...
      function verify() {
        ...
        if(document.getElementById("clickedButton").value == 'Save' || document.getElementById("clickedButton").value == 'Save AS New') {
            ...
            if(myLeftTrim(timer_type).length == 0) {
                ...
                $("#message").html("<td colspan='5' bgcolor='coral'><b>Timer Type is required...</b></td>");
                document.getElementById("timer_type").focus();
    ...
    function setDefaultColor(noOfRowsTraversed, noOfColumns) {
     ...
     function fillColumns(id) {
        ...
        document.getElementById("timer_id").value= document.getElementById(t1id + (lowerLimit + 0)).innerHTML;
        document.getElementById("timer_type").value = document.getElementById(t1id +(lowerLimit+2)).innerHTML;
 ...
 var popupwin = null;
            function displayMapList(){
               ...
               var url = "timerTypeCont?"+queryString;
               popupwin = openPopUp(url, "MCCB Details", 500, 1000);
                ...
                <DIV id="body" class="maindiv" align="center" >
                    <table width="100%" align="center">
                        <tr><td>
                                <table align="center">
                                    <tr>
                                        <td align="center" class="header_table" width="100%">TIMER</td>
                        ...
                        <tr>
                            <td> <div align="center">
                                    <form name="form0" method="POST" action="timerTypeCont">
                                        <table align="center" class="heading1" width="600">
                                            <tr>
                                                <th>Timer Type</th>
                                                <td><input class="input" type="text" id="searchTimerType" name="searchTimerType" value="${searchTimerType}" size="30" ></td>
                                        ...
                                        <table id="table1" width="600"  border="1"  align="center" class="content">
                                            ...
                                            <c:forEach var="timerTypeBean" items="${requestScope['timerTypeList']}"  varStatus="loopCounter">
                                                <tr  class="${loopCounter.index % 2 == 0 ? 'even': 'odd'}" >
                                                    ...
                                                    <td id="t1c${IDGenerator.uniqueID}" style="display:none" onclick="fillColumns(id)">${timerTypeBean.timer_id}</td>
                                                    <td id="t1c${IDGenerator.uniqueID}" onclick="fillColumns(id)" align="center">${lowerLimit - noOfRowsTraversed + loopCounter.count}</td>
                                                    <td id="t1c${IDGenerator.uniqueID}"  onclick="fillColumns(id)" >${timerTypeBean.timer_type}</td>
                                                    <td id="t1c${IDGenerator.uniqueID}"  onclick="fillColumns(id)" >${timerTypeBean.remark}</td>
                                                </tr>
                                            </c:forEach>
                                            <tr>
                                            ...
                                            <input  type="hidden" id="searchTimerType" name="searchTimerType" value="${searchTimerType}" >
                                        </table></DIV>
                                </form>
                            </td>
                        </tr>
                        ...
                        <tr>
                            <td align="center">
                                <div>
                                    <form name="form2" method="POST" action="timerTypeCont" onsubmit="return verify()">
                                        <table id="table2"  class="content" border="0"  align="center" width="600">
                                            ...
                                            <tr>
                                                <th class="heading1">Timer Type</th>
                                                <td>
                                                    <input class="input" type="hidden" id="timer_id" name="timer_id" value="$(searchTimerType)" >
                                                    <input class="input" type="text" id="timer_type" name="timer_type" value="" size="40" disabled>
                                                </td>
                                            </tr>
                                            ...
                                            <input type="hidden"  name="searchTimerType" value="${searchTimerType}" >
                                        </table>
                                    </form>
                                </div>
                            </td>
