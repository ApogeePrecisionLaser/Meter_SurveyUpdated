...
<html>
    <head>
        ...
        <script type="text/javascript" language="javascript">
            jQuery(function(){
                $("#city_name").autocomplete("JunSunriseSunsetCont.do", {
                    extraParams: {
                                ...
                                <td align="center">
                                    <table id="table0"  align="center" width="500" >
                                        ...
                                        <tr style="font-size:larger ;font-weight: 700;" >
                                            <td>
                                                <form name="form0" method="POST" action="JunSunriseSunsetCont.do" >
                                        ...
                                        <tr>
                                            <td>
                                                <form name="form1" action="JunSunriseSunsetCont.do" method="post">
                                        ...
                                        <tr>
                                            <td>
                                                <form name="form" id="form1" action="JunSunriseSunsetCont.do" method="get" onsubmit="return verify()">
