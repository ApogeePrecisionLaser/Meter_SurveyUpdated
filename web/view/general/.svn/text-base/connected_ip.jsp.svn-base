                ...
                <td>
                    <DIV id="body" class="maindiv">
                        <table cellspacing="0" id="table0"  align="center" >
                            <tr><td><table border="4" class="header_table" width="1000">
                            ...
                            <tr>
                                <td align="center" >
                                    <form name="form1" action="ConnectedIpCont" method="post">
                                        <table name="table1" border="1" width="500" align="center" class="reference">
                                            <tr>
