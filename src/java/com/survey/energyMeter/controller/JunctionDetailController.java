 ...
 * @author jpss
 */
public class JunctionDetailController extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        JunctionDetailModel junctionDetailModel = new JunctionDetailModel();
        ...
        String searchIvrs_no= request.getParameter("searchIvrs_no") == null ? "" : request.getParameter("searchIvrs_no");
        ...
        healthStatusMapModel.closeConnection();
        junctionDetailModel.closeConnection();
        request.getRequestDispatcher("junctionFullInfoView").forward(request, response);
    }
