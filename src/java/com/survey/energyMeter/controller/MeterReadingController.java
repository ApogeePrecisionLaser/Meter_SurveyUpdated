        ...
        try {
            ...
            if (jqstring != null) {
                ...
                if (jqstring.equals("getIvrs_no")) {
                    list = meterReadingModel.getIvrsNo(q);
                }
            ...
            String searchJunction,searchIvrs_no, searchReadingDateFrom, searchReadingDateTo, searchVoltage, searchVoltageValue, searchCurrent, searchCurrentValue, searchConnectedLoad, searchTimeFromHour, searchTimeFromMin, searchTimeToHour, searchTimeToMin;
            ...
            searchIvrs_no = request.getParameter("searchIvrs_no") == null ? "" : request.getParameter("searchIvrs_no");
            ...
            noOfRowsInTable = meterReadingModel.getNoOfRows(searchJunction,searchIvrs_no,searchReadingDateFrom, searchReadingDateTo, searchVoltage, searchVoltageValue, searchCurrent, searchCurrentValue, searchConnectedLoad, searchTimeFromHour, searchTimeFromMin, searchTimeToHour, searchTimeToMin);
            ...
            if(task.equals("showPdf")) {
                ...
                List<Readings> pdfList = meterReadingModel.showData(searchJunction,searchIvrs_no,searchReadingDateFrom, searchReadingDateTo, 0, noOfRowsInTable, searchVoltage, searchVoltageValue, searchCurrent, searchCurrentValue, searchConnectedLoad, searchTimeFromHour, searchTimeFromMin, searchTimeToHour, searchTimeToMin);
            ...
            List<Readings> list1 = meterReadingModel.showData(searchJunction,searchIvrs_no,searchReadingDateFrom, searchReadingDateTo,lowerLimit, noOfRowsToDisplay, searchVoltage, searchVoltageValue, searchCurrent, searchCurrentValue, searchConnectedLoad, searchTimeFromHour, searchTimeFromMin, searchTimeToHour, searchTimeToMin);
            ...
            request.setAttribute("searchIvrs_no",searchIvrs_no );
