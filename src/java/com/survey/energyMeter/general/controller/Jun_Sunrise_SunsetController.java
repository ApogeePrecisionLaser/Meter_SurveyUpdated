...
import com.survey.energyMeter.general.model.Jun_Sunrise_SunsetModel;
import com.survey.energyMeter.general.tableClasses.Jun_Sunrise_Sunset;
...
public class Jun_Sunrise_SunsetController extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        Jun_Sunrise_SunsetModel jun_Sunrise_SunsetModel = new Jun_Sunrise_SunsetModel();
        ServletContext ctx = getServletContext();
        jun_Sunrise_SunsetModel.setDriverClass(ctx.getInitParameter("driverClass"));
        jun_Sunrise_SunsetModel.setConnectionString(ctx.getInitParameter("connectionString"));
        jun_Sunrise_SunsetModel.setDb_userName(ctx.getInitParameter("db_username"));
        jun_Sunrise_SunsetModel.setDb_userPasswrod(ctx.getInitParameter("db_password"));
        jun_Sunrise_SunsetModel.setConnection();
        ...
        try {
            ...
            if (jqstring != null) {
                ...
                if (jqstring.equals("getCityName")) {
                    list = jun_Sunrise_SunsetModel.getCityName(q);
                }
        ...
        if (task.equals("DELETE")) {
            ...
            try {
                jun_Sunrise_SunsetModel.deleteRecord(date);
            } catch (Exception ex) {
        ...
        if (task.equals("SAVE") || task.equals("Save AS New")) {
            ...
            if (subTask.equals("NEW") || task.equals("Save AS New")) {
                try {
                    jun_Sunrise_SunsetModel.insertRecord(junSunriseSunset);
                } catch (Exception ex) {
        ...
        noOfRowsInTable = jun_Sunrise_SunsetModel.getNoOfRows(city_name_filter, year, month, date_filter);                  // get the number of records (rows) in the table.
        ...
        try {
            list1 = jun_Sunrise_SunsetModel.showData(lowerLimit, noOfRowsToDisplay, city_name_filter, year, month, date_filter);
        } catch (Exception ex) {
        ...
        request.setAttribute("message", jun_Sunrise_SunsetModel.getMessage());
        request.setAttribute("msgBgColor", jun_Sunrise_SunsetModel.getMsgBgColor());
