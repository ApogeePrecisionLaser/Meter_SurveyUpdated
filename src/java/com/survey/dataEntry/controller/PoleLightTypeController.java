...
import com.survey.dataEntry.model.PoleLightTypeModel;
 ...
 * @author JPSS
 */
public class PoleLightTypeController extends HttpServlet {
@Override
    ...
    int lowerLimit, noOfRowsTraversed, noOfRowsToDisplay = 10, noOfRowsInTable;
        ...
        PoleLightTypeModel sourceTypeModel = new PoleLightTypeModel();
        ...
        if (task == null) {
         ...
         if (task.equals("Delete")) {
           ...
           lightTypeBean.setSource_type(request.getParameter("light_type"));
           
             lightTypeBean.setIsParent(request.getParameter("isparent"));
             if(request.getParameter("isparent").equalsIgnoreCase("yes")){
              lightTypeBean.setIschild("no");
              lightTypeBean.setChildid(0);
             }else{
                   lightTypeBean.setIschild(request.getParameter("ischild"));
                 //  String childname=request.getParameter("Child");
              lightTypeBean.setChildid(sourceTypeModel.getChildId(request.getParameter("ischild")));
             }
        ...
        request.getRequestDispatcher("/Pole_Light_Type_View").forward(request, response);
