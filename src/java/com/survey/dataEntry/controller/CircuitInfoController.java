...
import com.survey.dataEntry.model.CircuitInfoModel;
 ...
 * @author Manpreet
 */
public class CircuitInfoController extends HttpServlet {
    @Override
    public void doGet(HttpServletRequest request, HttpServletResponse response) throws IOException, ServletException {
        ...
        CircuitInfoModel purposeHeaderModel = new CircuitInfoModel();
...
if(task.equals("AddMainParent")){
String pname=request.getParameter("parentheader");
int i=purposeHeaderModel.insertParentNodeRecord(pname);
int cg=0;
cg=purposeHeaderModel.getGenNo();
int f=0;
f=purposeHeaderModel.insertTreeRecord1(i,i,cg);
            ...
            List<CircuitInfoBean> PurposeHeaderList = purposeHeaderModel.showData(lowerLimit,noOfRowsToDisplay, parentheadername, subheadername,headerindex);
            ...
            request.getRequestDispatcher("CircuitInfoView").forward(request, response);
        } catch (Exception e) {
