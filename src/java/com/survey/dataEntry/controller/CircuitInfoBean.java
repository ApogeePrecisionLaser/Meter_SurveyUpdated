...
public class CircuitInfoBean {
   ...
   // private String index_no;
    ...
    private ArrayList<CircuitInfoBean> itemHeader;

     public ArrayList<CircuitInfoBean> getItemHeader() {
        return itemHeader;
    }

    public void setItemHeader(ArrayList<CircuitInfoBean> itemHeader) {
        this.itemHeader = itemHeader;
    }

    private ArrayList<CircuitInfoBean> itemLeaf;

    public ArrayList<CircuitInfoBean> getItemLeaf() {
        return itemLeaf;
    }

    public void setItemLeaf(ArrayList<CircuitInfoBean> itemLeaf) {
