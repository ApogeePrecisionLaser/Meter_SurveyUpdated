...
import com.survey.waterworks.model.OHLevelModel;
...
public class OHLevelController extends HttpServlet {
    ...
    //    if (request.getAttribute("isSelectPriv").equals("Y")) {
            ...
            List<OHLevel> ohLevelList = ohLevelModel.getAllRecords(lowerLimit, noOfRowsToDisplay, searchWaterTreatmentPlant, searchOverHeadTank);
