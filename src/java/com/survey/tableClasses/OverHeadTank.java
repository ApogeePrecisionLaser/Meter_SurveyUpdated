...
public class OverHeadTank {
    private int overHeadTankId,cityId,waterTreatmentPlantId;
    ...
    /**
     * @param capacityHeight the capacityHeight to set
     */
    ...
    /**
     * @param capacityLTR the capacityLTR to set
     */
